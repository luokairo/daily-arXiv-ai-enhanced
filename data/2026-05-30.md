...
- [多模态生成](#direction-multimodal_generation) [Total: 106]
...
- [未分类](#direction-uncategorized) [Total: 24]
  - [未分类](#direction-uncategorized-uncategorized) [Total: 24]
...
Classification reason: 该论文研究实时流式视频到视频编辑（V2V），属于视频编辑范畴，与多模态生成方向下的[CANONICAL] subtopic "visual_editing（图像与视频编辑）"高度匹配。同时涉及生成式 AI方向下的视频音频生成应用。
...
Classification reason: 该论文研究布局到图像生成（L2I），属于可控图像生成范畴，与多模态生成方向下的 [CANONICAL] subtopic "图像与视频编辑"（visual_editing）中的可控编辑高度相关。同时该任务也属于生成式 AI领域内容生成应用。
...
### [16] [Inference-Free Multimodal Learned Sparse Retrieval for Production-Scale Visual Document Search](https://arxiv.org/abs/2605.30917)
...
### [24] [OmniMem: Scalable and Adaptive Memory Retrieval for Long Video Generation](https://arxiv.org/abs/2605.30519)
...
Classification reason: 该论文提出 TunerDiT，一种无需训练的视频扩散 Transformer 渐进式引导方法，用于多事件文生视频生成。核心方法基于视频 DiT 去噪轨迹分析，属于文生视频与视频扩散方向，因此映射到 [CANONICAL] subtopic "文生视频与视频扩散" (text_to_video_diffusion)。同时论文涉及多事件生成评测基准 Meve，也可归入 生成式 AI 方向。
...
Classification reason: 该论文研究全球不同国家用户对生成式AI聊天机器人的使用模式差异，属于生成式 AI应用层面的实证分析与评测，与[生成式 AI 评测与基准]（evaluation_benchmark）中关于生成式 AI使用行为、人类偏好评估的主题高度相关。

Importance reason: This paper focuses on 生成式 AI usage patterns and digital divides, which is outside the user's core technical priorities in multimodal generation and model efficiency. Signals: 生成式 AI 评测与基准, 用户行为分析, 语言差异, 数字鸿沟, 非技术方向
...
Classification reason: 该论文研究面向保密敏感领域的离线机器翻译，属于垂直领域（翻译）的生成应用，与 [CANONICAL] 领域内容生成应用（domain_application）高度匹配。
...
### [30] [On-Device Generative AI for GDPR-Compliant Visual Monitoring: Natural Language Alerts from Local Object Detection](https://arxiv.org/abs/2605.30544)
...
Classification reason: 该论文属于生成式 AI方向，描述了一个边缘设备上的隐私保护视觉监控系统，使用本地LLM生成自然语言警报。这属于垂直领域（监控/安全）的生成应用，与domain_application（领域内容生成应用）高度匹配。
...
Classification reason: 该论文专注于从自然语言生成物理示意图，属于科学/物理领域的垂直内容生成应用，与现有 subtopic "领域内容生成应用"（domain_application）高度匹配。该 subtopic 在 multimodal_generation 和 生成式 AI 方向下均有定义，可直接复用。
...
### [32] [Crafter: A Multi-Agent Harness for Editable Scientific Figure Generation from Diverse Inputs](https://arxiv.org/abs/2605.30611)
...
### [33] [Controllable Lung Nodule Synthesis via Histogram-Regularized Latent Diffusion Models](https://arxiv.org/abs/2605.30631)
...
Classification reason: 该论文聚焦于医学影像（肺部CT）中的肺结节可控生成，属于医疗垂直领域的生成应用，因此映射到现有 subtopic "领域内容生成应用"（domain_application），该 subtopic 在 multimodal_generation 和 生成式 AI 方向下均有收录。
...
### [35] [Linear Ensembles Wash Away Watermarks: On the Fragility of Distributional Perturbations in LLMs](https://arxiv.org/abs/2605.30501)
...
Classification reason: 该论文研究LLM生成文本的水印脆弱性问题，属于生成式 AI方向下的水印与版权保护（watermark_copyright）这一[CANONICAL]子主题，直接对应水印的鲁棒性与安全性分析。
...
Classification reason: 该论文构建了 EHRBench，一个基于电子健康记录的临床决策 LLM 评测基准，属于 生成式 AI 评测与基准（evaluation_benchmark）范畴，该 [CANONICAL] 子主题涵盖生成式 AI 的评测基准构建。
...
### [37] [Functional MRI Time Series Generation via Wavelet-Based Image Transform and Spectral Flow Matching for Brain Disorder Identification](https://arxiv.org/abs/2605.30387)
...
Classification reason: 该论文提出 fMRI 时间序列生成方法（DSFM），属于医疗/科学领域的生成应用，与 multimodal_generation 和 生成式 AI 方向下的现有 subtopic "领域内容生成应用"（domain_application）高度匹配。
...
### [38] [NumLeak: Public Numeric Benchmarks as Latent Labels in Foundation Models](https://arxiv.org/abs/2605.30393)
*Anany Kotawala*
...
Classification reason: 该论文研究公开数值基准在预训练数据中导致模型记忆而非真正泛化的评测污染问题（NumLeak框架），属于生成式 AI评测与基准方向下的评测可靠性问题，与evaluation_benchmark（生成式 AI评测与基准）高度匹配。
...
### [39] [Bounded Behavioral Indistinguishability for Black-Box LLM Distillation](https://arxiv.org/abs/2605.30448)
*Munawar Hasan*
...
Classification reason: 该论文研究黑盒LLM蒸馏的行为不可区分性评估，提出有界行为不可区分性形式化框架，属于生成式 AI评测范畴（评估蒸馏模型是否真正模仿了教师模型的行为），因此映射到[生成式 AI评测与基准]子主题。
...
### [40] [Text-guided Feature Disentanglement for Cross-modal Gait Recognition](https://arxiv.org/abs/2605.30784)
...
Classification reason: 该论文研究跨模态步态识别（LiDAR-相机），属于生物特征识别这一垂直领域应用。虽然步态识别不是典型的"生成"任务，但论文使用了文本引导的特征解耦、CLIP对齐等生成式多模态技术，且该论文更接近多模态生成方向下的领域应用。现有taxonomy中multimodal_generation方向下已有domain_application（领域内容生成应用）这一非canonical子主题，步态识别作为生物特征识别领域的应用可归入此主题。
...
### [41] [Auditing LLM Benchmarks with Item Response Theory](https://arxiv.org/abs/2605.30504)
...
Classification reason: 该论文使用项目反应理论（IRT）审计LLM基准测试中的标签错误，属于对生成式 AI/LLM评测基准的质量审计与评估，与[生成式 AI 评测与基准]（evaluation_benchmark）高度匹配。
...
### [42] [ImmigrationQA: A Source-Grounded Dataset and Small-Model Adaptation for U.S. Immigration Law](https://arxiv.org/abs/2605.30589)
*Nazarii Shportun*
...
Classification reason: 该论文构建了美国移民法律领域的问答数据集 ImmigrationQA，并对 Llama 3.2 3B 模型进行微调，属于法律垂直领域的生成应用。这与 [CANONICAL] 子主题 "领域内容生成应用"（domain_application）高度匹配。
...
Classification reason: 该论文提出基于人格（persona）的多元对齐评估框架，核心关注生成式AI的评测方法，与 [CANONICAL] subtopic "生成式 AI 评测与基准"（evaluation_benchmark）高度匹配。同时涉及对齐（alignment）和评估多样性，但评测是主线。

Importance reason: Focuses on AI alignment evaluation, not on the user's priority subtopics like continuous VLM, video generation, or model efficiency. Signals: 生成式 AI evaluation, persona-based benchmarking, pluralistic alignment, state-space drift, not matching priority subtopics
...
### [44] [idSCD: Identifying Training Datasets through Semantic Correlation Descriptors](https://arxiv.org/abs/2605.30462)
...
Classification reason: 该论文研究通过语义相关性描述符（SCD）识别训练数据集归属，属于生成式 AI检测与溯源范畴（模型训练数据溯源/归因），与 canonical subtopic "生成式 AI 检测与溯源" 高度匹配。
...
### [45] [SteerFace: Debiasing Synthetic Face Generation via Adaptive Residue Perturbation](https://arxiv.org/abs/2605.30894)
...
Classification reason: 该论文研究利用合成人脸数据训练人脸识别模型，核心是改进合成数据的质量以缩小与真实数据的差距，属于合成训练数据生成范畴。synthetic_data（合成数据与数据集蒸馏）是[CANONICAL]子主题，完美匹配。同时该论文也涉及多模态生成（扩散模型生成人脸），因此也匹配multimodal_generation方向。
...
### [46] [COLLEAGUE.SKILL: Automated AI Skill Generation via Expert Knowledge Distillation](https://arxiv.org/abs/2605.31264)
...
### [47] [Industrializing Prediction-Powered Inference: The GLIDE Library for Reliable GenAI and Agentic Systems Evaluation](https://arxiv.org/abs/2605.31278)
...
Classification reason: 该论文提出 GLIDE 库，统一了预测驱动推断（PPI）方法用于可靠评估生成式 AI 与智能体系统，核心贡献在于评估方法论与工具，属于 生成式 AI 评测与基准方向，因此复用 canonical 子主题 evaluation_benchmark。
...
### [48] [DiTTo: Scalable Order-aware All-in-One Image Restoration Agent](https://arxiv.org/abs/2605.30915)
...
Classification reason: 该论文提出基于视觉语言模型的图像恢复智能体（DiTTo Agent），通过调度多个预构建的恢复专家模块实现多退化图像恢复，属于LLM智能体与自动化生成工作流的范畴，与[生成式 AI]方向下的[AI 智能体与生成工作流]规范主题高度匹配。
...
### [49] [Eywa: Provenance-Grounded Long-Term Memory for AI Agents](https://arxiv.org/abs/2605.30771)
*Resham Joshi*
...
Classification reason: 该论文提出 Eywa，一种面向 AI 智能体的、基于溯源的长时记忆架构，核心关注智能体的记忆检索、审计、更新与擦除能力，属于 LLM 智能体与生成工作流范畴，因此映射到 [CANONICAL] subtopic "AI 智能体与生成工作流" (agent_workflow)。
...
### [50] [Anchoring LLM Gender Bias to Human Baselines: A Cross-Lingual Audit](https://arxiv.org/abs/2605.30804)
...
Classification reason: 该论文对多个LLM进行跨语言的性别刻板印象审计，属于生成式 AI内容质量与公平性评测范畴，与[生成式 AI 评测与基准]（evaluation_benchmark）高度匹配。
...
Classification reason: 该论文聚焦于医疗LLM的机器遗忘（machine unlearning）基准测试，属于生成模型遗忘学习范畴，与生成式 AI方向下的[CANONICAL] subtopic "概念擦除与遗忘学习"（unlearning_erasure）高度匹配。
...
Classification reason: 该论文利用多模态基础模型（MFM）从真实低质量图像生成高质量目标，构建了GGT-100K合成配对数据集用于图像复原训练，属于合成训练数据生成范畴，与现有 canonical subtopic "合成数据与数据集蒸馏"（synthetic_data）高度匹配。
...
### [53] [PatchWorld: Gradient-Free Optimization of Executable World Models](https://arxiv.org/abs/2605.30880)
...
Classification reason: 该论文提出 PatchWorld 框架，通过反例引导的代码修复将离线轨迹转化为可执行的 Python 世界模型，用于文本智能体环境中的预测与规划。这属于 LLM 智能体与生成工作流（agent_workflow）范畴，同时涉及世界模型生成（video_world_model 方向），但核心贡献是智能体世界模型的代码化构建，因此主方向为 生成式 AI。
...
Classification reason: 该论文研究针对检索增强文生音乐系统的字幕投毒攻击，属于生成式 AI安全与治理范畴。safety_governance（生成内容安全与治理）是[CANONICAL]子主题，涵盖有害内容检测、安全攻击等，与此论文高度匹配。
...
### [56] [CodeGolf Bench: A Multi-Language Benchmark for Evaluating Concise Code Generation Capabilities of Large Language Models](https://arxiv.org/abs/2605.30394)
*Vedant Padwal*
...
Classification reason: 该论文提出 CodeGolf Bench，一个评估 LLM 在 60 种编程语言中生成简洁代码能力的基准，属于 生成式 AI 领域中的代码生成评测，与 [CANONICAL] 子主题 "生成式 AI 评测与基准" 高度匹配。
...
Classification reason: 该论文提出了 TSM-Bench，一个用于评估 AI 生成文本检测器在真实维基百科编辑场景中表现的多语言、多生成器、多任务基准。这属于 生成式 AI 检测与评测交叉领域，但核心贡献是评测基准，因此映射到 [CANONICAL] 的 evaluation_benchmark（生成式 AI 评测与基准）。
...
Classification reason: 该论文研究语言模型使用自身生成的合成文本进行自训练的效果与条件，核心关注合成数据的效用（compatibility）及其与模型能力的关系，属于合成数据领域。现有 [CANONICAL] subtopic "synthetic_data"（合成数据与数据集蒸馏）完全匹配。
...
### [60] [Latent Geometric Chords for Query-Efficient Decision-Based Adversarial Attacks](https://arxiv.org/abs/2605.31219)
...
### [61] [Steering LLMs? Actually, Sparse Autoencoders can outperform simple baselines](https://arxiv.org/abs/2605.31183)
...
Classification reason: 该论文研究使用稀疏自编码器（SAE）对LLM进行模型引导（steering），属于生成内容安全与治理范畴下的模型行为控制与安全引导。映射到生成式 AI方向下的[CANONICAL] subtopic "生成内容安全与治理"（safety_governance），因为模型引导是确保生成内容安全、可控的重要手段。
...
### [62] [Learning Whom to Trust: Market-Feedback Adaptive Retrieval for Frozen LLMs in Event-Driven Financial RAG](https://arxiv.org/abs/2605.31201)
...
Classification reason: 该论文研究金融领域的检索增强生成（RAG）系统，属于垂直领域（金融）的生成应用，与 [CANONICAL] 子主题 "领域内容生成应用"（domain_application）高度匹配。
...
Classification reason: 该论文聚焦于CT影像报告自动生成，属于医疗垂直领域的生成应用，与现有 canonical 子主题"领域内容生成应用"（domain_application）高度匹配。
...
### [65] [Divergence Decoding: Inference-Time Unlearning via Auxiliary Models](https://arxiv.org/abs/2605.31293)
...
Classification reason: 该论文提出 Divergence Decoding 方法，通过辅助模型在推理时引导 LLM 的 logits 远离特定数据，实现模型遗忘（unlearning），属于生成模型的概念擦除与遗忘学习。该方向在 生成式 AI 和 multimodal_generation 下均有 [CANONICAL] 的 unlearning_erasure 子主题，因此直接复用。
...
Classification reason: 该论文研究手语翻译（SLT），属于垂直领域（手语）的生成/翻译应用，与现有 canonical 子主题 "领域内容生成应用"（domain_application）高度匹配。同时涉及多模态（视频-文本）生成，因此也匹配 multimodal_generation 方向。
...
### [67] [Welfare, Improvability, and Variance: A Principal-Agent Approach to Optimal Benchmark Item Aggregation](https://arxiv.org/abs/2605.30916)
...
Classification reason: 该论文研究 AI 基准测试的聚合方法，提出基于主-从博弈的框架来评估 benchmark 中每个测试项的社会福利、可改进性和方差，属于 生成式 AI 评测与基准方向，与 [CANONICAL] subtopic '生成式 AI 评测与基准' 高度匹配。
...
### [68] [De-attribute to Forget for LLM Unlearning](https://arxiv.org/abs/2605.30919)
...
Classification reason: 该论文研究LLM遗忘学习（unlearning），属于生成式 AI方向下的[CANONICAL]概念擦除与遗忘学习（unlearning_erasure）子主题。同时，该主题也出现在multimodal_generation和multimodal_understanding_generation方向的非规范子主题列表中，因此匹配多个方向。
...
### [69] [SCOPE: Self-Play via Co-Evolving Policies for Open-Ended Tasks](https://arxiv.org/abs/2605.31433)
...
### [70] [What Gets Unmasked First? Trajectory Analysis of Diffusion Models for Graph-to-Text Generation](https://arxiv.org/abs/2605.31564)
...
Classification reason: 该论文研究图到文本生成（graph-to-text generation），属于结构化数据到文本的生成任务，可归入领域内容生成应用（domain_application）这一现有子主题。该子主题在 multimodal_generation 和 生成式 AI 方向下均有收录，涵盖垂直领域生成应用。
...
### [71] [Improving Small Language Models for Code Generation with Reinforcement Learning from Verification Feedback](https://arxiv.org/abs/2605.30478)
...
Classification reason: 该论文研究使用强化学习（RLVR）提升小语言模型的代码生成能力，属于代码生成这一垂直领域应用。现有 taxonomy 中 domain_application（领域内容生成应用）明确包含代码生成，且该 subtopic 在 生成式 AI 和 multimodal_generation 两个方向下均有定义，因此直接复用。
...
### [72] [Design and Evaluation of Multi-Agent AI Oracle Systems for Prediction Market Resolution](https://arxiv.org/abs/2605.30802)
*Tarun Kota*
...
### [73] [Differentially Private Preference Data Synthesis for Large Language Model Alignment](https://arxiv.org/abs/2605.30808)
...
Classification reason: 该论文提出差分隐私合成偏好数据生成方法，属于合成训练数据生成范畴，与 [CANONICAL] 子主题"合成数据与数据集蒸馏"（synthetic_data）高度匹配。
...
### [74] [AnchorSteer: Self-Discovered Concept Injection for Structure-Preserving Music Editing](https://arxiv.org/abs/2605.31053)
...
### [75] [Latent Space Disentanglement via Activation Steering for Interpretable Attribute Control in Symbolic Music Generation](https://arxiv.org/abs/2605.31295)
...
Classification reason: 该论文研究符号音乐生成中的可解释属性控制，属于创意与艺术生成范畴，与 [CANONICAL] creative_art（创意与艺术生成）高度匹配。同时，符号音乐生成也属于多模态生成中的音频生成方向。
...
### [76] [MergeTok: Unified Continuous and Discrete Visual Tokenization via Token Merging](https://arxiv.org/abs/2605.30904)
...
### [78] [LVSA: Training-Free Sparse Attention for Long Video Diffusion](https://arxiv.org/abs/2605.31057)
...
### [79] [QVGGT: Post-Training Quantized Visual Geometry Grounded Transformer](https://arxiv.org/abs/2605.31124)
...
### [80] [Are Full Rollouts Necessary for On-Policy Distillation?](https://arxiv.org/abs/2605.31490)
...
### [81] [Fixed-Point Masked Generative Modeling](https://arxiv.org/abs/2605.31215)
...
Classification reason: 该论文提出可配置的安全奖励模型（CSRM），用于大语言模型的安全对齐，核心贡献在于奖励建模与安全对齐。该主题与 [CANONICAL] subtopic "生成模型对齐与奖励"（generation_alignment）高度匹配，该 subtopic 在 生成式 AI 和 multimodal_generation 方向下均有定义，且明确包含 reward modeling、alignment 等关键词。
...
Classification reason: 该论文研究成对偏好对齐的统计形式化，定义了一个模型级的序数可观测量来度量模型评分与参考偏好排序的一致性。这与"生成模型对齐与奖励"（generation_alignment）高度相关，该子主题涵盖偏好优化、对齐、奖励建模等核心内容。该子主题在 multimodal_generation 和 生成式 AI 方向下均有收录，且为 CANONICAL 条目。
...
Classification reason: 该论文研究 on-policy 蒸馏中教师模型的监督信号衰减问题，并提出基于未来 token 置信度的组奖励机制（Lookahead Group Reward），属于生成模型的对齐与奖励优化范畴。该论文同时涉及 生成式 AI 方向（生成工作流中的蒸馏与对齐），但核心贡献在奖励建模与偏好优化，因此主方向为多模态生成下的 generation_alignment 子主题。
...
Classification reason: 该论文提出联邦变分偏好对齐框架 FedVPA-GP，用于在联邦学习场景下对 LLM 进行个性化偏好对齐，核心是偏好优化与对齐问题。这与 multimodal_generation 和 生成式 AI 方向下的 [CANONICAL] 子主题"生成模型对齐与奖励"（generation_alignment）高度匹配。
...
### [89] [Trust-Region Behavior Blending for On-Policy Distillation](https://arxiv.org/abs/2605.31159)
...
### [90] [A Unifying View of Variational Generative Wasserstein Flows](https://arxiv.org/abs/2605.31369)
...
### [93] [Conformal Reliability: A New Evaluation Metric for Conditional Generation](https://arxiv.org/abs/2605.30807)
...
Classification reason: 该论文提出了一种基于共形预测的条件生成模型可靠性评估指标（reliability score），属于生成模型的评测方法。这与 multimodal_generation 方向下的 [CANONICAL] subtopic "generation_benchmark（生成模型评测与数据集）" 高度匹配，该 subtopic 涵盖生成模型评测基准、自动评测指标等。同时该工作也涉及 生成式 AI 方向下的评测。
...
### [94] [Benchmarking and Enhancing Text-to-Image Models for Generating Visual Representations in Early Arithmetic Education](https://arxiv.org/abs/2605.31212)
...
### [96] [Physically Viable World Models: A Case for Query-Conditioned Embodied AI](https://arxiv.org/abs/2605.30542)
...
### [97] [SLAP: The Semantic Least Action Principle for Variational Video-Language Modeling](https://arxiv.org/abs/2605.30750)
...
### [98] [Robust Dreamer: Deviation-Aware Latent Gaussian Memory for Action-Controlled AR Video Generation](https://arxiv.org/abs/2605.30855)
...
### [99] [Light Interaction: Training-Free Inference Acceleration for Interactive Video World Models](https://arxiv.org/abs/2605.31158)
...
### [100] [Probabilistic Precipitation Nowcasting with Rectified Flow Transformers](https://arxiv.org/abs/2605.31204)
...
### [103] [Towards Streaming Synchronized Spatial Audio Generation via Autoregressive Diffusion Transformer](https://arxiv.org/abs/2605.30940)
...
### [104] [Chatterbox-Flash: Prior-Calibrated Block Diffusion for Streaming Zero-Shot TTS](https://arxiv.org/abs/2605.30748)
...
Classification reason: 该论文提出零样本文本到语音（TTS）生成模型，属于音频生成方向，与多模态生成方向下的 [CANONICAL] 子主题 "audio_av_generation（音频与多模态联合生成）" 高度匹配。同时该工作也属于 生成式 AI 范畴下的内容生成应用。
...
### [105] [3DAE: Binaural Quality Assessment for Audio Novel View Synthesis with Spatial Maps and Benchmark](https://arxiv.org/abs/2605.30469)
*Jialu Xu, Yifan Zhou*
...
### [106] [ImmersiveTTS: Environment-Aware Text-to-Speech with Multimodal Diffusion Transformer and Domain-Specific Representation Alignment](https://arxiv.org/abs/2605.30965)
...
Classification reason: 该论文提出环境感知的文本到语音（TTS）模型，融合语音与环境音频的跨模态生成，属于多模态生成方向下的[CANONICAL]子主题"音频与多模态联合生成"（audio_av_generation），该子主题涵盖TTS、语音合成、音视频联合生成等。同时该论文也涉及生成式 AI方向下的内容生成应用。
...
### [107] [Hide-and-Seek in Trajectories: Discovering Failure Signals for VLA Runtime Monitoring](https://arxiv.org/abs/2605.30834)
...
### [108] [Vision-Language Models Suppress Female Representations Under Ambiguous Input](https://arxiv.org/abs/2605.31556)
...
### [109] [Immuno-VLM: Immunizing Large Vision-Language Models via Generative Semantic Antibodies for Open-World Trustworthiness](https://arxiv.org/abs/2605.30745)
...
### [110] [What Makes LVLMs Hallucinate Less? Unveiling the Architectural Factors Behind Hallucination Robustness](https://arxiv.org/abs/2605.30911)
...
### [111] [Human-Alignment, Calibration, and Activation Patterns in Large Language Model Uncertainty](https://arxiv.org/abs/2605.30675)
...
### [112] [Learning from Fine-Grained Visual Discrepancies: Mitigating Multimodal Hallucinations via In-Context Visual Contrastive Optimization](https://arxiv.org/abs/2605.31312)
...
### [113] [YARD: Y-Architecture Register Decoding for Efficient Hallucination Mitigation in Large Vision-Language Models](https://arxiv.org/abs/2605.31429)
...
### [114] [BenHalluEval: A Multi-Task Hallucination Evaluation Framework for Large Language Models on Bengali](https://arxiv.org/abs/2605.31483)
...
### [116] [Attend to Evidence: Evidence-Anchored Spatial Attention Supervision for Multimodal RLVR](https://arxiv.org/abs/2605.30912)
...
### [117] [ReGuLaR: Relation-Grounded Latent Reasoning for Large Vision-Language Models](https://arxiv.org/abs/2605.30587)
...
### [118] [Seeing Before Agreeing: Aligning Multi-Agent Consensus with Visual Evidence](https://arxiv.org/abs/2605.30698)
...
### [119] [Diversity Matters: Revisiting Test-Time Compute in Vision-Language Models](https://arxiv.org/abs/2605.30713)
...
### [121] [iVGR: Internalizing Visually Grounded Reasoning for MLLMs with Reinforcement Learning](https://arxiv.org/abs/2605.31096)
...
### [123] [GSAM: A Generalizable and Safe Robotic Framework for Articulated Object Manipulation](https://arxiv.org/abs/2605.30740)
...
### [124] [LongTraceRL: Learning Long-Context Reasoning from Search Agent Trajectories with Rubric Rewards](https://arxiv.org/abs/2605.31584)
...
### [125] [Variational Adapter for Cross-modal Similarity Representation](https://arxiv.org/abs/2605.30968)
...
### [126] [FOCUS: Forcing In-Context Object Localization through Visual Support Constraints and Policy Optimization](https://arxiv.org/abs/2605.31145)
...
### [127] [Beyond Classification: Dynamic Adapter Routing for Continual Multimodal Retrieval](https://arxiv.org/abs/2605.31229)
...
### [128] [Seeing Isn't Knowing: Do VLMs Know When Not to Answer Spatial Questions (and Why)?](https://arxiv.org/abs/2605.30557)
...
### [129] [PInVerify: An Offline Embodied Benchmark for Active Instance Verification](https://arxiv.org/abs/2605.30639)
*Yuhang Jiang*
...
### [130] [BilliardPhys-Bench: Benchmarking Physical Reasoning and Visual Dynamics of Multimodal LLMs](https://arxiv.org/abs/2605.30900)
...
### [131] [FBHM: Functional Benchmarking and Steering of VLMs for Hateful Meme Detection](https://arxiv.org/abs/2605.31349)
...
Classification reason: 该论文提出了FBHM基准，系统性地构建了基于功能性的仇恨模因数据集，用于评测VLM在多模态理解中的鲁棒性和泛化能力，属于多模态评测与基准（multimodal_benchmark）这一[CANONICAL]子主题。同时涉及生成式 AI方向的安全治理（仇恨内容检测）。
...
### [132] [TeachObs: A Human-Validated Benchmark for Multimodal Teaching Observation and Model Evaluation](https://arxiv.org/abs/2605.30673)
...
Classification reason: 该论文提出了一个针对课堂教学视频的多模态教学观察基准 TeachObs，包含细粒度标注和课程级评估，属于多模态评测与基准（multimodal_benchmark）这一规范主题。同时该基准涉及 AI 生成内容评测，也匹配 生成式 AI 评测与基准（evaluation_benchmark）。
...
### [133] [FAM-Bench: A Multimodal Benchmark for Condition-Aware Food-as-Medicine Reasoning](https://arxiv.org/abs/2605.31410)
...
### [135] [MineExplorer: Evaluating Open-World Exploration of MLLM Agents in Minecraft](https://arxiv.org/abs/2605.30931)
...
### [136] [Probing Collision Grounding in Vision-Language Models for Safe Human-Robot Collaboration](https://arxiv.org/abs/2605.31196)
...
Classification reason: 该论文提出了TouchSafeBench，一个用于评估VLM碰撞接地能力的物理仿真基准，属于多模态评测与基准（multimodal_benchmark）这一[CANONICAL]子主题。同时涉及机器人安全监控，也匹配生成式 AI方向下的生成内容安全与治理（safety_governance）子主题。
...
### [137] [On the Robustness of Multilingual Text Embedding Rankings Across Learning Tasks, Languages, and Benchmark Datasets](https://arxiv.org/abs/2605.31142)
...
### [138] [ERGeoBench:A Comprehensive Benchmark for Embodied Reasoning and Geo-localization in Multimodal Large Language Models](https://arxiv.org/abs/2605.31251)
...
### [139] [A Visually Impaired Assistance Benchmark for VLM-as-a-Judge Evaluation](https://arxiv.org/abs/2605.31351)
...
Classification reason: 该论文提出了 VIABLE，一个针对视障辅助（VIA）场景的 VLM-as-a-Judge 评测基准，属于多模态评测与基准（multimodal_benchmark）这一规范主题。同时涉及 生成式 AI 评测（evaluation_benchmark）方向，但核心贡献是 VLM 作为评判者的多模态评测基准，因此主方向为多模态理解与生成。
...
### [140] [SVI-Bench: A Dynamic Microworld for Strategic Video Intelligence](https://arxiv.org/abs/2605.31529)
...
### [141] [EGOSTREAM: A Diagnostic Benchmark for Streaming Episodic Memory in Egocentric Vision](https://arxiv.org/abs/2605.31557)
...
### [142] [nuReasoning: A Reasoning-Centric Dataset and Benchmark for Long-Tail Autonomous Driving](https://arxiv.org/abs/2605.31572)
...
### [144] [TRINE: A Token-Aware, Runtime-Adaptive FPGA Inference Engine for Multimodal AI](https://arxiv.org/abs/2603.22867)
...
### [145] [VisionPulse: Dynamic Visual Sparsity for Efficient Multimodal Reasoning](https://arxiv.org/abs/2605.31457)
...
### [146] [Linear Scaling Video VLMs for Long Video Understanding](https://arxiv.org/abs/2605.31598)
...
### [147] [Rationalize: Shared Semantic Reasoning for Human-AI Alignment](https://arxiv.org/abs/2605.30632)
...
Classification reason: 该论文提出 Rationalize 框架，将人机交互建模为互补角色对（Explorer-Guide, Investigator-Informant, Teacher-Student, Judge-Advocate），在共享推理空间中实现人类与 AI（如 LLM）的对齐。这属于 AI 智能体与生成工作流（agent_workflow）范畴，涉及 LLM 智能体、人机协作工作流与对齐设计。同时与多模态理解与生成方向下的对齐主题相关。
...
Classification reason: 该论文研究策展人引导的多语言艺术描述生成，面向盲人和低视力观众，属于垂直领域（博物馆/艺术）的内容生成应用。该主题与现有 subtopic "领域内容生成应用"（domain_application）高度匹配，该 subtopic 在 multimodal_understanding_generation 方向下也有收录，因此复用该 subtopic。
...
### [149] [Harness Updating Is Not Harness Benefit: Disentangling Evolution Capabilities in Self-Evolving LLM Agents](https://arxiv.org/abs/2605.30621)
...
Classification reason: 论文研究 LLM 智能体的自演化能力（harness self-evolution），涉及智能体通过更新 prompt、skills、memories、tools 等外部 harness 来提升任务执行能力，属于 AI 智能体与生成工作流范畴，因此映射到 canonical 子主题 agent_workflow。
...
Classification reason: 该论文聚焦于病理学全切片图像（WSI）的结构化报告生成，属于医疗垂直领域的生成应用，与现有 subtopic "领域内容生成应用"（domain_application）高度匹配。该 subtopic 在 multimodal_understanding_generation 和 生成式 AI 方向下均有存在，且为 CANONICAL 条目。
...
### [152] [COMPASS: Cognitive MCTS-Guided Process Alignment for Safe Search Agents](https://arxiv.org/abs/2605.30838)
...
Classification reason: 该论文关注 LLM 搜索智能体的安全对齐问题，属于 生成式 AI 方向下的生成内容安全与治理（safety_governance）范畴，同时涉及多步推理与工具使用的智能体工作流，也与 agent_workflow 相关。
...
### [153] [UniScale: Adaptive Unified Inference Scaling via Online Joint Optimization of Model Routing and Test-Time Scaling](https://arxiv.org/abs/2605.30898)
...
Classification reason: 该论文提出UniScale框架，将模型路由（在不同规模模型间切换）与测试时扩展（TTS）统一为在线联合优化问题，属于LLM推理工作流的智能调度与自动化优化，与生成式 AI方向下的"AI智能体与生成工作流"（agent_workflow）高度匹配。
...
### [154] [GUI-C$^2$: Coarse-to-Fine GUI Grounding via Difficulty-Aware Reinforcement Learning](https://arxiv.org/abs/2605.30884)
...
Classification reason: 该论文研究 GUI 智能体中的视觉定位（GUI grounding）问题，属于多模态理解与生成方向下的 AI 智能体与生成工作流（agent_workflow）范畴。论文提出的粗到细定位机制和强化学习训练策略属于智能体工具使用与自动化工作流优化，与现有 canonical 子主题高度匹配。
...
### [155] [The Architecture of Errors: From Universal Impossibility to Patch-Local LLM Reliability](https://arxiv.org/abs/2605.30628)
...
Classification reason: 论文从理论上论证了通用LLM可靠性无法通过有限干预字典保证，但提出了在操作有界补丁（如法律审查、医疗RAG、代码修复等）中可靠性是可实现的局部问题。这属于生成式 AI生成内容可靠性评测与基准的理论框架，与生成式 AI评测与基准（evaluation_benchmark）方向高度相关。
...
### [156] [Learning to Adapt: Self-Improving Web Agent via Cognitive-Aware Exploration](https://arxiv.org/abs/2605.31365)
...
Classification reason: 该论文提出基于MLLM的Web智能体SCALE，通过自认知探索与环境交互实现自主学习和适应，属于LLM智能体与自动化工作流范畴，与[生成式 AI]方向下的[AI智能体与生成工作流]规范主题高度匹配。
...
### [157] [Generating Reports or Repeating Templates? Measuring and Mitigating Template Collapse in 3D CT Report Generation](https://arxiv.org/abs/2605.30984)
...
Classification reason: 该论文研究3D CT影像报告生成，属于医疗垂直领域的生成应用，与现有 canonical 子主题"领域内容生成应用"(domain_application)高度匹配。同时涉及视觉语言模型(VLM)在医学影像中的应用，也匹配多模态理解与生成方向。
...
Classification reason: 该论文提出 ExpGraph，一种模型无关的经验学习框架，通过图结构记忆帮助 LLM 智能体复用历史经验（成功策略与失败教训），属于 LLM 智能体与生成工作流方向。该论文与 生成式 AI 方向下的 [CANONICAL] subtopic "AI 智能体与生成工作流" 高度匹配，同时与多模态理解与生成方向下的智能体工作流也有交叉。
...
### [159] [Counterfactual Evaluation Reveals Hidden Capability Profiles in Clinical LLMs and Agents](https://arxiv.org/abs/2605.30590)
*Matt Turk*
...
Classification reason: 该论文提出了一种新的因果敏感性评分（CSS）来评估临床LLM和智能体的响应能力，属于生成式 AI评测与基准（evaluation_benchmark）这一规范主题。同时，论文涉及临床AI智能体的评估，也与AI智能体与生成工作流（agent_workflow）相关，但核心贡献是评测方法，因此主方向为生成式 AI评测。
...
### [160] [Task-Focused Memorization for Multimodal Agents](https://arxiv.org/abs/2605.31075)
...
Classification reason: 该论文研究多模态智能体的长期记忆策略，属于多模态智能体（multimodal agent）工作流范畴。在 multimodal_understanding_generation 方向下，agent_workflow（AI 智能体与生成工作流）是唯一匹配的现有 subtopic，涵盖 LLM 智能体、工具使用、自动化等关键词。同时论文也涉及 生成式 AI 方向下的智能体工作流。
...
### [161] [Detect in Any Scene: An Agentic Framework for Object Detection with Experience-Aware Reasoning](https://arxiv.org/abs/2605.31174)
...
Classification reason: 该论文提出基于 MLLM 智能体的目标检测框架，通过智能体动态组合恢复模块和检测器来构建检测工作流，属于 LLM 智能体与自动化工作流范畴，因此映射到 [CANONICAL] 的 agent_workflow（AI 智能体与生成工作流）。
...
### [162] [The Regularizing Power of Language-Training Deepfake Detectors](https://arxiv.org/abs/2605.31192)
...
Classification reason: 该论文研究深度伪造检测（deepfake detection），属于 生成式 AI 检测与溯源这一 [CANONICAL] 子主题的核心范畴。同时涉及 MLLM 用于检测，也与多模态理解与生成方向相关。
...
### [163] [Wind Turbine Maintenance Log Labelling Framework: LLM-Driven Data Correction and Enrichment via Semantic Extraction of Reliability Intelligence](https://arxiv.org/abs/2605.31281)
...
Classification reason: 该论文利用LLM对风力涡轮机维护日志进行结构化标注、数据校正与语义增强，属于能源/工业领域的垂直应用，与[CANONICAL] subtopic "领域内容生成应用"（domain_application）高度匹配。
...
### [164] [Preference-Aware Rubric Learning for Personalized Evaluation](https://arxiv.org/abs/2605.31545)
...
Classification reason: 该论文研究个性化评估方法，属于生成式 AI评测范畴，与[生成式 AI 评测与基准]（evaluation_benchmark）高度匹配。同时涉及个性化对齐，也与多模态理解与生成方向下的对齐相关。

Importance reason: Focuses on personalized evaluation for text generation, which is not a priority subtopic and lacks direct connection to the user's core interests in multimodal generation and autoregressive video/image generation. Signals: 生成式 AI evaluation, personalized alignment, rubric learning, text generation, no multimodal or generation focus
...
Classification reason: 该论文研究对抗性补丁（adversarial patches）的场景鲁棒性评估，属于AI生成/对抗内容的安全评估范畴，与生成式 AI方向下的"生成内容安全与治理"（safety_governance）高度相关，该子主题涵盖有害内容检测与安全评测。
...
### [166] [BlueFin: Benchmarking LLM Agents on Financial Spreadsheets](https://arxiv.org/abs/2605.30907)
...
Classification reason: 该论文提出了一个针对金融电子表格场景的 LLM 智能体评测基准 BlueFin，属于 生成式 AI 评测与基准（evaluation_benchmark）这一规范主题。同时，该基准涉及 LLM 智能体在专业领域的应用，也与多模态理解与生成方向下的 AI 智能体与生成工作流（agent_workflow）相关。
...
Classification reason: 该论文提出针对LLM的黑盒防御方法，通过对抗攻击与防御的协同进化来检测恶意查询，属于生成内容安全与治理范畴，与生成式 AI方向下的[CANONICAL] subtopic "生成内容安全与治理"（safety_governance）高度匹配。
...
### [168] [DeMaVLA: A Vision-Language-Action Foundation Model for Generalizable Deformable Manipulation](https://arxiv.org/abs/2605.31286)
...
Classification reason: 该论文提出 DeMaVLA，一个面向可变形物体操作的视觉-语言-动作（VLA）基础模型，涉及机器人操作智能体、数据聚合工作流（DAgger）和自动化操作流水线。这与 multimodal_understanding_generation 方向下的 [CANONICAL] 子主题 "AI 智能体与生成工作流"（agent_workflow）高度匹配，因为该子主题涵盖 LLM 智能体、工作流、工具使用和自动化流水线，VLA 模型正是多模态理解与机器人动作生成的智能体系统。
...
### [169] [Send a SCOUT First: Pre-hoc Reasoning for Adaptive Detector Allocation in Prompt-Injection Defense](https://arxiv.org/abs/2605.30837)
...
Classification reason: 该论文研究提示注入攻击的防御策略，属于生成式 AI安全治理范畴。提示注入是LLM/生成式 AI系统面临的关键安全威胁，论文提出的自适应检测器分配框架SCOUT属于内容安全与治理方向，因此映射到[CANONICAL] subtopic "生成内容安全与治理" (safety_governance)。
...
### [170] [VLM3: Vision Language Models Are Native 3D Learners](https://arxiv.org/abs/2605.30561)
...
### [171] [SpatialAct: Probing Spatial Reasoning-to-Action Capabilities of VLM Agents in 3D Scenes](https://arxiv.org/abs/2605.31148)
...
### [172] [Multi-Turn Multi-Agent Dialogue for Collaborative Reconstruction Improves VLM Performance on Spatial Reasoning, But Only Barely](https://arxiv.org/abs/2605.31387)
...
### [173] [VLM-GLoc: Vision-Language Model Enhanced Monte Carlo Localization for Robust Semantic Global Localization in Cluttered Quasi-Static Environments](https://arxiv.org/abs/2605.30506)
...
### [174] [Representation Forcing for Bottleneck-Free Unified Multimodal Models](https://arxiv.org/abs/2605.31604)
...
### [175] [How can embedding models bind concepts?](https://arxiv.org/abs/2605.31503)
...
### [176] [Personalize Your Large Vision-language Models With In-context Prompt Tuning](https://arxiv.org/abs/2605.31513)
...
### [178] [Annotations Are Not All You Need: A Cross-modal Knowledge Transfer Network for Unsupervised Temporal Sentence Grounding](https://arxiv.org/abs/2605.30742)
...
### [179] [MechVQA: Benchmarking and Enhancing Multimodal LLMs on Comprehensive Mechanical Drawing Understanding](https://arxiv.org/abs/2605.30794)
...
### [181] [Recognizing Co-Speech Gestures in-the-Wild](https://arxiv.org/abs/2605.31589)
...
### [182] [PEEK: Picking Essential frames via Efficient Knowledge distillation](https://arxiv.org/abs/2605.31029)
...
### [183] [Towards Effective Long-Video Event Prediction via Multi-Level Event Semantics Mining](https://arxiv.org/abs/2605.31069)
...
### [184] [HiERO-StepG @ Ego4D Step Grounding Challenge: hierarchical activity understanding enables zero-shot step grounding](https://arxiv.org/abs/2605.31227)
...
### [185] [UXR PoV for Neuroinclusive Emotion Regulation](https://arxiv.org/abs/2605.31131)
...
Classification reason: 该论文将生成式AI应用于数字心理健康领域（ADHD情绪调节），属于垂直领域内容生成应用，与domain_application（领域内容生成应用）高度匹配。
...
### [186] [Extending the UXR Point of View Pyramid: A Generative AI-Augmented Methodology for Human-Centred AI Systems](https://arxiv.org/abs/2605.31143)
...
Classification reason: 该论文提出了一种生成式AI增强的UXR方法论框架，将GenAI嵌入用户研究工作流中，用于债务管理金融系统的以人为中心AI设计。这属于AI智能体与生成工作流（agent_workflow）范畴，因为核心贡献是将生成式AI作为工作流中的辅助工具，支持合成、假设生成和结构化提示架构，属于自动化创作流水线/工作流增强方向。
...
### [187] [Personalized to Persuade: The Effects of Contextualization and Warmth on Trust and Reliance in Conversational AI](https://arxiv.org/abs/2605.31275)
...
Classification reason: 该论文研究对话式AI中个性化（contextualization）与温暖感（warmth）对用户信任和依赖的影响，属于生成式 AI方向下的个性化与对话生成（personalization_persona）这一规范子主题，该子主题涵盖个性化助手与对话生成。

Importance reason: Focuses on human-AI trust and persuasion, not on core generative model architectures or efficiency. Signals: HCI study, no generative model contribution, no technical novelty for 生成式 AI, user trust experiment, low alignment with priority subtopics
...
### [188] [EUDAIMONIA: Evaluating Undesirable Dynamics in AI](https://arxiv.org/abs/2605.30654)
...
Classification reason: 该论文提出了 Social AI Design Code 框架和 EUDAIMONIA 基准，用于评估 LLM 在社交互动中对用户福祉的负面影响（如有害亲密、依赖、过度参与），属于 生成式 AI 生成内容的质量与安全评测范畴，与 [CANONICAL] 的 evaluation_benchmark（生成式 AI 评测与基准）高度匹配。
...
### [189] [Protocol for evaluating ChatGPT in biomedical association generation and verification using a RAG-enabled, cross-model majority voting workflow](https://arxiv.org/abs/2605.30400)
...
### [190] [Generalistic or Specific Embeddings, Which is Better? An Empirical Study on Search for Clinical Coding in Non-English Languages](https://arxiv.org/abs/2605.30529)
...
### [191] [MAAT: Multi-phase Adapter-Aware Targeted Unlearning](https://arxiv.org/abs/2605.30514)
...
### [192] [Sound effects in media:A comparative analysis of recorded and synthetic samples in live-action and animation](https://arxiv.org/abs/2605.31082)
...
Classification reason: 该论文研究程序化音频（数字拟音）在影视和动画中的合成音效与真实录音的对比感知，属于生成式 AI方向下的音视频内容创作应用。现有[CANONICAL] subtopic "视频音频生成应用"（video_audio_creation）涵盖音频编辑、内容创作产品级生成应用，与该论文主题高度匹配。
...
### [193] [Same Patient, Different Words, Different Diagnosis? Evaluating Semantic Stability in Clinical LLMs](https://arxiv.org/abs/2605.30646)
...
Classification reason: 该论文研究临床LLM在语义等价改写下的稳定性与鲁棒性，属于医疗垂直领域的LLM应用评估，与现有[生成式 AI]方向下的[领域内容生成应用]（domain_application）高度匹配。
...
### [194] [Counterfactual Graph for Multi-Agent LLM Calibration](https://arxiv.org/abs/2605.30653)
...
Classification reason: 该论文研究多智能体LLM系统的校准问题，属于LLM智能体工作流中的可靠性提升方向，与[生成式 AI]方向下的[AI智能体与生成工作流]（agent_workflow）高度匹配。
...
### [195] [ElasticMem: Latent Memory as a Learnable Resource for LLM Agents](https://arxiv.org/abs/2605.30690)
...
Classification reason: 该论文提出 ElasticMem，一种为 LLM 智能体设计的可学习弹性记忆框架，核心是增强智能体的长期记忆与推理能力，属于 LLM 智能体与生成工作流范畴，因此映射到 [CANONICAL] subtopic agent_workflow。
...
### [196] [LLM-FACETS: A Privacy-Preserving Framework for Evaluating LLM Transparency and Accountability](https://arxiv.org/abs/2605.31167)
...
Classification reason: 该论文提出 LLM-FACETS 框架，用于评估 LLM 输出的事实性、校准性和可复现性，属于 生成式 AI 生成内容质量评测范畴，与 [CANONICAL] 子主题 "生成式 AI 评测与基准" 高度匹配。
...
### [198] [MosaicLeaks:Privacy Risks in Querying-in-the-Open for Deep Research Agents](https://arxiv.org/abs/2605.30727)
...
Classification reason: 该论文研究深度研究智能体在查询外部工具时泄露私有文档信息的隐私风险，属于生成式 AI方向下的生成内容安全与治理（safety_governance）范畴，关注AI系统的隐私泄露与安全治理问题。
...
### [199] [AutoSci: A Memory-Centric Agentic System for the Full Scientific Research Lifecycle](https://arxiv.org/abs/2605.31468)
...
Classification reason: 该论文提出 AutoSci，一个基于 LLM 的科研智能体系统，覆盖文献理解、实验、写作、审稿回复等完整科研工作流，属于 AI 智能体与自动化工作流范畴，因此映射到 [CANONICAL] subtopic agent_workflow。
...
### [200] [Extending AI for Research to the Humanities: A Multi-Agent Framework for Evidence-Grounded Scholarship](https://arxiv.org/abs/2605.30947)
...
Classification reason: 论文提出 SPIRE 多智能体框架，将人文学科研究操作（来源发现、证据注释、比较、溯源检查等）建模为协作智能体角色，属于 LLM 智能体与生成工作流方向，与 canonical 子主题 agent_workflow 高度匹配。
...
### [201] [BIAS-ID: A Framework for Analyzing Transformation Biases in AI-Generated Image Detectors](https://arxiv.org/abs/2605.31153)
...
Classification reason: 论文研究 AI 生成图像检测器的变换偏差分析框架，属于 生成式 AI 检测方向，与 [CANONICAL] subtopic "生成式 AI 检测与溯源" 高度匹配。

Importance reason: Focuses on AI-generated image detector bias, which is outside the user's priority subtopics and negative keywords apply. Signals: 生成式 AI detection, transformation bias, forensic artifacts, detector evaluation, spurious correlations
...
### [202] [KnowledgeGain: Evaluating and Optimizing Science News Generation for Reader Learning](https://arxiv.org/abs/2605.31099)
...
Classification reason: 该论文提出 KnowledgeGain 指标，用于评估科学新闻生成内容对读者知识获取的效果，属于生成内容质量评测范畴，与 [CANONICAL] subtopic "生成式 AI 评测与基准" 高度匹配。

Importance reason: Focuses on science news evaluation for reader learning, not on the user's priority subtopics like multimodal generation or autoregressive video. Signals: 生成式 AI evaluation, science news generation, reader knowledge gain, LLM reader simulator, not multimodal generation
...
### [203] [An Organization-Scoped LLM Agent Runtime Architecture for Regulated Cybersecurity Operations](https://arxiv.org/abs/2605.30604)
...
Classification reason: 该论文提出面向网络安全运营的LLM智能体运行时架构，涉及多智能体协作、工具调用、人机交互工作流等核心内容，与生成式 AI方向下的[AI智能体与生成工作流]规范子主题高度匹配。
...
### [204] [Authentication of Copy Detection Patterns via Cross-Camera Dual-Synthetic Referencing](https://arxiv.org/abs/2605.31292)
...
Classification reason: 该论文研究 Copy Detection Patterns (CDP) 的认证方法，涉及印刷品防伪检测与对抗伪造攻击，属于 生成式 AI 检测与溯源方向下的深伪检测/生成内容认证范畴，因此映射到 canonical 子主题 detection_attribution。

Importance reason: Focuses on 生成式 AI detection/traceability for physical copy patterns, which is outside the user's priority subtopics and negative-keyword-filtered. Signals: 生成式 AI detection, cross-camera authentication, copy detection patterns, no autoregressive/video/diffusion/world model, no continuous VLM
...
### [205] [Learning Multi-Agent Coordination via Sheaf-ADMM](https://arxiv.org/abs/2605.31005)
...
Classification reason: 该论文聚焦于多语言骨科临床决策支持，属于医疗垂直领域的自然语言处理与分类应用，与 [CANONICAL] 子主题"领域内容生成应用"（domain_application）高度匹配。
...
### [208] [Knowledge Boundary Probing and Demand-Guided Intervention for LLM-Based Power System Code Generation](https://arxiv.org/abs/2605.31478)
...
Classification reason: 该论文聚焦电力系统领域的代码生成，属于垂直领域（能源/电力）的生成应用，与 [CANONICAL] 子主题 "领域内容生成应用"（domain_application）高度匹配。
