...
- [多模态生成](#direction-multimodal_generation) [Total: 108]
  ...
  - [未分类](#direction-multimodal_generation-uncategorized) [Total: 48]
...
- [多模态理解与生成](#direction-multimodal_understanding_generation) [Total: 78]
  ...
  - [未分类](#direction-multimodal_understanding_generation-uncategorized) [Total: 23]
...
- [未分类](#direction-uncategorized) [Total: 25]
  - [未分类](#direction-uncategorized-uncategorized) [Total: 25]
...
Classification reason: 该论文提出实时流式视频到视频编辑框架，属于视频编辑方向，映射到 multimodal_generation 下的 [CANONICAL] subtopic "visual_editing"（图像与视频编辑）。同时涉及 生成式 AI 方向下的视频音频生成应用。
...
Classification reason: 该论文提出一种无需训练的视频超分辨率（VSR）框架，属于视频质量增强与修复任务，与[CANONICAL] subtopic "图像与视频编辑"（visual_editing）中的视频编辑/修复方向高度匹配。同时涉及生成式 AI领域的生成内容质量提升。
...
Classification reason: 该论文研究GenAI图像编辑中的内容偏移与幻觉缓解问题，提出结构保持的后处理融合框架，属于图像编辑范畴。multimodal_generation方向下的[CANONICAL] subtopic "visual_editing"（图像与视频编辑）完美匹配。同时该工作也涉及生成式 AI方向下的生成内容质量与编辑应用。
...
### [15] [Envisioning Beyond the Few: Disentangled Semantics and Primitives for Few-Shot Atypical Layout-to-Image Generation](https://arxiv.org/abs/2605.31266)
...
### [16] [Text-guided Feature Disentanglement for Cross-modal Gait Recognition](https://arxiv.org/abs/2605.30784)
...
### [21] [DriveMA: Driving Vision-Language-Action Models with verifiable Meta-Actions](https://arxiv.org/abs/2605.31271)
...
### [23] [Dreaming Of Others: Latent Teammate Modeling In World Models For Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2605.31361)
*Tomas Leroy-Stone*
...
Classification reason: 该论文提出 CameraNoise，通过几何流引导的噪声扭曲方法实现视频扩散中的精确相机姿态控制，属于视频扩散模型中的可控生成方法。最佳匹配方向为多模态生成下的 [CANONICAL] 文生视频与视频扩散（text_to_video_diffusion），同时与 生成式 AI 方向下的视频音频生成应用（video_audio_creation）也相关。
...
### [25] [SlotMemory: Object-Centric KV Memory for Streaming Long-Video Generation](https://arxiv.org/abs/2605.31033)
...
### [26] [TunerDiT: Training-free Progressive Steering of Diffusion Transformer for Multi-Event Video Generation](https://arxiv.org/abs/2605.31590)
...
Classification reason: 该论文提出 TunerDiT，一种无需训练的多事件视频生成渐进式引导方法，基于视频扩散 Transformer（DiT）的逆向过程分析。核心属于文生视频与视频扩散方向，因此映射到 multimodal_generation 下的 [CANONICAL] subtopic "文生视频与视频扩散"（text_to_video_diffusion）。同时论文包含自建评测套件 Meve，也涉及 生成式 AI 评测，因此匹配 生成式 AI 方向。
...
### [27] [On-Device Generative AI for GDPR-Compliant Visual Monitoring: Natural Language Alerts from Local Object Detection](https://arxiv.org/abs/2605.30544)
...
Classification reason: 该论文构建了一个边缘设备上的隐私保护视觉监控系统，使用YOLOv5n进行本地目标检测，并通过本地LLM（Phi-3 Mini）生成自然语言警报。这属于垂直领域（监控/安全）的生成应用，与domain_application（领域内容生成应用）高度匹配。
...
### [28] [How Early Adopters Used Generative AI Worldwide: Variation by Country Income and Language](https://arxiv.org/abs/2605.30685)
...
Classification reason: 该论文研究全球不同国家用户对生成式AI聊天机器人的使用模式差异，属于生成式 AI应用层面的实证分析与评测，与[生成式 AI 评测与基准]子主题相关（关注生成式 AI使用行为、跨文化差异与数字鸿沟评估）。

Importance reason: This paper is a social science analysis of 生成式 AI usage patterns, not a technical advance in the user's priority subtopics. Signals: 生成式 AI usage analysis, cross-country study, language bias, education vs leisure, no technical contribution to generation models
...
### [29] [Translation Analytics for Freelancers II: Benchmarking Local LLMs for Confidential Translation Workflows](https://arxiv.org/abs/2605.31452)
...
Classification reason: 该论文研究面向保密翻译场景的本地LLM翻译基准测试，属于垂直领域（翻译/语言服务）的生成应用，与现有规范子主题"领域内容生成应用"（domain_application）高度匹配。
...
### [30] [Crafter: A Multi-Agent Harness for Editable Scientific Figure Generation from Diverse Inputs](https://arxiv.org/abs/2605.30611)
...
### [31] [Controllable Lung Nodule Synthesis via Histogram-Regularized Latent Diffusion Models](https://arxiv.org/abs/2605.30631)
...
Classification reason: 该论文聚焦于肺部结节合成这一医疗垂直领域生成应用，属于"领域内容生成应用"（domain_application）范畴，该 subtopic 在 multimodal_generation 和 生成式 AI 方向下均有收录，且为 CANONICAL 条目，因此直接复用。
...
### [32] [PhyDrawGen: Physically Grounded Diagram Generation from Natural Language](https://arxiv.org/abs/2605.30512)
...
Classification reason: 该论文提出从自然语言生成物理示意图的神经符号流水线，属于科学/物理领域的垂直内容生成应用，与现有 canonical 子主题"领域内容生成应用"（domain_application）高度匹配。
...
Classification reason: 该论文研究使用合成人脸数据训练人脸识别模型，核心是改进合成数据的质量以缩小与真实数据的差距，属于合成训练数据生成范畴。synthetic_data（合成数据与数据集蒸馏）是[CANONICAL]子主题，完美匹配。同时该论文也涉及多模态生成（扩散模型生成人脸），因此也匹配multimodal_generation方向。
...
### [34] [DiTTo: Scalable Order-aware All-in-One Image Restoration Agent](https://arxiv.org/abs/2605.30915)
...
Classification reason: 该论文提出基于视觉语言模型的图像恢复智能体（DiTTo Agent），通过调度多个预训练恢复专家模块实现多退化图像恢复，属于LLM智能体与自动化工作流范畴，与agent_workflow（AI智能体与生成工作流）高度匹配。
...
### [35] [Exploring Autonomous Agentic Data Engineering for Model Specialization](https://arxiv.org/abs/2605.30407)
...
### [36] [Linear Ensembles Wash Away Watermarks: On the Fragility of Distributional Perturbations in LLMs](https://arxiv.org/abs/2605.30501)
...
Classification reason: 该论文研究LLM文本水印的脆弱性，属于生成式 AI方向下的水印与版权保护（watermark_copyright）这一[CANONICAL]子主题，直接对应水印的鲁棒性与安全性分析。
...
### [37] [Auditing LLM Benchmarks with Item Response Theory](https://arxiv.org/abs/2605.30504)
...
Classification reason: 该论文使用项目反应理论（IRT）审计LLM基准测试中的标签错误，属于对生成模型评测基准的质量评估与审计，与[生成式 AI 评测与基准]（evaluation_benchmark）高度匹配。
...
### [38] [EHRBench: An Automated and Reliable EHR-based Benchmark for Clinical Decision Making with LLMs](https://arxiv.org/abs/2605.30637)
...
Classification reason: 该论文构建了基于电子健康记录（EHR）的临床决策基准 EHRBench，用于评估 LLM 在诊断、治疗和预后等临床决策任务上的表现，属于 生成式 AI 方向下的评测与基准（evaluation_benchmark）子主题。
...
Classification reason: 该论文聚焦于fMRI脑功能成像数据的生成，属于医疗/科学领域的生成应用，与现有非规范化的 subtopic "domain_application（领域内容生成应用）" 高度匹配。该 subtopic 在 multimodal_generation 和 生成式 AI 方向下均有收录，且描述明确包含"医疗/科学等垂直领域生成应用"。
...
Classification reason: 该论文研究大模型在公开数值基准上的记忆泄露问题（NumLeak），属于生成模型的安全与治理范畴。映射到 生成式 AI 方向下的 [CANONICAL] 子主题"生成内容安全与治理"（safety_governance），因为论文核心关注模型记忆导致的安全隐患（数据泄露、评估污染）及防御措施（系统提示防御），与内容安全、合规监管高度相关。
...
### [41] [Bounded Behavioral Indistinguishability for Black-Box LLM Distillation](https://arxiv.org/abs/2605.30448)
*Munawar Hasan*
...
Classification reason: 该论文研究黑盒LLM蒸馏的行为不可区分性评估，提出有界行为不可区分性形式化框架，属于生成式 AI评测范畴（评估蒸馏模型是否真正模仿了教师模型的行为），因此映射到[生成式 AI评测与基准]这一规范子主题。
...
### [42] [GGT-100K: Generative Ground Truth for Generalizable Real-World Image Restoration](https://arxiv.org/abs/2605.31039)
...
Classification reason: 该论文使用大语言模型（Gemini）生成合成数据来训练临床编码检索器，属于利用生成模型构建合成训练数据的典型工作，因此映射到 生成式 AI 方向下的 [CANONICAL] 子主题"合成数据与数据集蒸馏"。
...
Classification reason: 该论文构建了美国移民法律领域的问答数据集并微调模型，属于法律垂直领域的生成应用，与 [CANONICAL] 子主题 "领域内容生成应用" (domain_application) 高度匹配。
...
Classification reason: 该论文提出基于人格（persona）的多元对齐评估框架，核心贡献在于生成式AI的评测方法论，属于生成式 AI评测与基准方向。论文讨论的是评估框架而非具体生成模型，因此归入生成式 AI方向的[生成式 AI 评测与基准]（evaluation_benchmark）最为贴切。同时论文涉及对齐（alignment）概念，与generation_alignment也有交叉，但评测是主线。

Importance reason: Focuses on AI evaluation and alignment, not on core generative model architectures or efficiency. Signals: 生成式 AI evaluation, persona-based alignment, not autoregressive or diffusion generation, no video/image generation, no model efficiency
...
### [46] [idSCD: Identifying Training Datasets through Semantic Correlation Descriptors](https://arxiv.org/abs/2605.30462)
...
Classification reason: 该论文研究通过语义相关性描述符（SCD）识别训练数据集归属，属于生成式 AI检测与溯源方向（detection_attribution），该子主题涵盖生成模型溯源与归因，与本论文的dataset membership inference任务高度吻合。

Importance reason: Focuses on dataset membership inference, not on the user's priority generative or multimodal topics. Signals: Dataset membership inference, Semantic correlation descriptors, White-box fingerprinting, 生成式 AI detection, Not generative modeling
...
Classification reason: 该论文聚焦乳腺钼靶影像报告生成，属于医疗垂直领域的生成应用，与 [CANONICAL] 子主题 "领域内容生成应用" (domain_application) 高度匹配。
...
### [48] [COLLEAGUE.SKILL: Automated AI Skill Generation via Expert Knowledge Distillation](https://arxiv.org/abs/2605.31264)
...
Classification reason: 该论文提出了一套从专家知识痕迹自动蒸馏为可检查、可修正、可部署的AI技能包的端到端工作流，属于LLM智能体技能生成与自动化工作流范畴，与[生成式 AI]方向下的[AI智能体与生成工作流]规范子主题高度匹配。
...
### [49] [Industrializing Prediction-Powered Inference: The GLIDE Library for Reliable GenAI and Agentic Systems Evaluation](https://arxiv.org/abs/2605.31278)
...
Classification reason: 该论文提出 GLIDE 库，统一了预测驱动推断（PPI）方法用于可靠评估生成式 AI 和智能体系统，核心关注评估方法的可靠性与效率，属于 生成式 AI 评测与基准方向，因此映射到 canonical 子主题 evaluation_benchmark。
...
### [50] [Eywa: Provenance-Grounded Long-Term Memory for AI Agents](https://arxiv.org/abs/2605.30771)
*Resham Joshi*
...
Classification reason: 该论文提出 Eywa，一种面向 AI 智能体的、基于溯源（provenance）的长期记忆架构，核心关注智能体的记忆检索、审计、更新与擦除能力，属于 LLM 智能体与生成工作流范畴，因此映射到 [CANONICAL] 的 agent_workflow（AI 智能体与生成工作流）。
...
### [51] [Anchoring LLM Gender Bias to Human Baselines: A Cross-Lingual Audit](https://arxiv.org/abs/2605.30804)
...
Classification reason: 该论文审计了多个LLM中的性别刻板印象偏见，属于生成式 AI治理与公平性范畴，与[CANONICAL] subtopic "生成内容安全与治理"（safety_governance）高度匹配。
...
### [52] [AMNESIA: A Large Scale Medical Unlearning Benchmark Suite with Disease-Informed Analysis](https://arxiv.org/abs/2605.30599)
...
Classification reason: 该论文聚焦于医疗LLM的机器遗忘（machine unlearning），属于生成模型/LLM的概念擦除与遗忘学习范畴，与生成式 AI方向下的[CANONICAL] subtopic "概念擦除与遗忘学习"（unlearning_erasure）高度匹配。
...
### [53] [Mental Damage: Caption Poisoning Attacks on Retrieval-Augmented Text-to-Music Generation](https://arxiv.org/abs/2605.30365)
...
Classification reason: 该论文研究检索增强文生音乐系统中的字幕投毒攻击，属于生成式 AI安全与治理范畴。safety_governance（生成内容安全与治理）是[CANONICAL]子主题，涵盖内容安全、有害内容检测等，与本论文的攻击与安全风险分析高度匹配。
...
Classification reason: 该论文研究黑盒对抗攻击方法，属于AI安全领域。在生成式 AI方向下，[CANONICAL] subtopic "生成内容安全与治理"（safety_governance）涵盖内容审核、有害内容检测等安全主题，对抗攻击是安全治理的重要组成部分，因此映射至此。
...
### [55] [CodeGolf Bench: A Multi-Language Benchmark for Evaluating Concise Code Generation Capabilities of Large Language Models](https://arxiv.org/abs/2605.30394)
*Vedant Padwal*
...
Classification reason: 该论文提出了 CodeGolf Bench，一个评估 LLM 在 60 种编程语言中生成简洁代码能力的基准，属于 生成式 AI 领域中的代码生成评测，与 [CANONICAL] 子主题 "生成式 AI 评测与基准" 高度匹配。
...
### [56] [Astra: a generalizable report generation foundation model for 3D computed tomography](https://arxiv.org/abs/2605.31437)
...
Classification reason: 该论文聚焦于CT影像报告生成这一医疗垂直领域应用，属于生成式 AI方向下的"领域内容生成应用"（domain_application）子主题，该子主题明确包含医疗生成应用。同时论文涉及多模态（3D CT图像到文本报告）生成，也匹配多模态生成方向。
...
### [57] [Beyond Static Dialogues: Benchmarking Realistic, Heterogeneous, and Evolving Long-Term Memory](https://arxiv.org/abs/2605.31086)
...
Classification reason: 该论文提出了一个面向 LLM 长期记忆的评测基准 RHELM，属于 生成式 AI 方向下的评测与基准范畴，与 canonical 子主题 evaluation_benchmark（生成式 AI 评测与基准）高度匹配。
...
### [58] [TSM-Bench: Detecting LLM-Generated Text in Real-World Wikipedia Editing Practices](https://arxiv.org/abs/2605.31113)
...
Classification reason: 该论文提出了 TSM-Bench，一个用于评估 AI 生成文本检测器在真实维基百科编辑场景中表现的多语言、多生成器、多任务基准。这属于 生成式 AI 检测与评测的交叉领域，但核心贡献是评测基准，因此映射到 [CANONICAL] 的 evaluation_benchmark（生成式 AI 评测与基准）。

Importance reason: Focuses on 生成式 AI detection in Wikipedia, which is outside the user's priority subtopics and has negative keywords like "clinical" not directly applicable. Signals: 生成式 AI detection benchmark, task-specific MGT, generalization asymmetry, low personal relevance to user's multimodal generation focus
...
### [59] [Not All Synthetic Data Is Yours to Learn From](https://arxiv.org/abs/2605.31126)
...
Classification reason: 该论文研究语言模型在无提示、无监督条件下使用自身生成的合成文本进行自训练的效果，核心关注合成数据的效用（兼容性）及其与能力提升/记忆解耦的关系，属于合成数据用于模型训练的范畴，因此映射到 [CANONICAL] 子主题 synthetic_data（合成数据与数据集蒸馏）。同时论文也涉及生成模型（语言模型自生成文本），因此也匹配 multimodal_generation 方向。
...
Classification reason: 该论文研究使用稀疏自编码器（SAE）对LLM进行模型引导（steering），属于生成内容安全与治理范畴下的模型行为控制与安全生成方向。现有safety_governance（生成内容安全与治理）子主题涵盖内容审核、有害内容检测、安全生成等，与本文的模型输出引导与安全控制高度相关。
...
### [61] [Learning Whom to Trust: Market-Feedback Adaptive Retrieval for Frozen LLMs in Event-Driven Financial RAG](https://arxiv.org/abs/2605.31201)
...
Classification reason: 该论文研究金融领域的检索增强生成（RAG）系统，属于垂直领域内容生成应用，与 [CANONICAL] 子主题"领域内容生成应用"（domain_application）高度匹配。
...
### [62] [Divergence Decoding: Inference-Time Unlearning via Auxiliary Models](https://arxiv.org/abs/2605.31293)
...
Classification reason: 该论文提出 Divergence Decoding 方法，通过辅助模型在推理时引导 LLM 的 logits 远离特定数据，实现模型遗忘（unlearning），属于生成模型的概念擦除与遗忘学习方向。该方向在 生成式 AI 下有 [CANONICAL] 子主题 unlearning_erasure，且论文也探索了在图像生成领域的泛化性，因此也匹配 multimodal_generation 方向。
...
### [63] [Unlearning in Diffusion Models: A Unified Framework with KL Divergence and Likelihood Constraints](https://arxiv.org/abs/2605.30825)
...
Classification reason: 该论文研究扩散模型中的遗忘学习（unlearning），属于生成模型概念擦除与遗忘学习的核心主题。该主题在 multimodal_generation 和 生成式 AI 两个方向下均有对应的 [CANONICAL] 子主题 unlearning_erasure（概念擦除与遗忘学习），因此直接复用该子主题。
...
Classification reason: 该论文研究手语翻译（SLT），属于垂直领域内容生成应用。手语翻译是语言翻译的一个特殊子领域，使用LLM进行目标端释义增强来提升翻译质量，符合"领域内容生成应用"（domain_application）的定义。该子主题在生成式 AI和multimodal_generation方向下均有收录。
...
### [65] [De-attribute to Forget for LLM Unlearning](https://arxiv.org/abs/2605.30919)
...
Classification reason: 该论文研究LLM遗忘学习（unlearning），属于生成模型安全与遗忘范畴。unlearning_erasure（概念擦除与遗忘学习）是[CANONICAL]子主题，完美匹配。同时该主题也出现在multimodal_generation和multimodal_understanding_generation方向下，因此匹配多个方向。
...
### [66] [SCOPE: Self-Play via Co-Evolving Policies for Open-Ended Tasks](https://arxiv.org/abs/2605.31433)
...
Classification reason: 该论文提出SCOPE框架，通过自我对弈（self-play）协同进化两个策略（Challenger生成任务，Solver多轮检索回答），实现开放任务的语言模型训练。这属于LLM智能体与自动化工作流范畴，与agent_workflow（AI智能体与生成工作流）高度匹配。
...
### [67] [What Gets Unmasked First? Trajectory Analysis of Diffusion Models for Graph-to-Text Generation](https://arxiv.org/abs/2605.31564)
...
Classification reason: 该论文研究图到文本生成（graph-to-text generation），属于结构化数据到文本的生成任务，可归入"领域内容生成应用"（domain_application）这一现有子主题。该子主题涵盖医疗/法律/科学/代码等垂直领域生成应用，图到文本生成（如知识图谱描述）属于结构化数据到文本的生成范畴。
...
### [68] [Improving Small Language Models for Code Generation with Reinforcement Learning from Verification Feedback](https://arxiv.org/abs/2605.30478)
...
Classification reason: 该论文研究使用强化学习（RLVR）提升小语言模型的代码生成能力，属于代码生成这一垂直领域应用。现有 taxonomy 中 domain_application（领域内容生成应用）明确包含代码生成，且该 subtopic 在 生成式 AI 和 multimodal_generation 两个方向下均有定义，是最佳匹配。
...
### [69] [Design and Evaluation of Multi-Agent AI Oracle Systems for Prediction Market Resolution](https://arxiv.org/abs/2605.30802)
*Tarun Kota*
...
Classification reason: 该论文研究多智能体LLM架构用于预测市场结果裁决，属于LLM智能体与自动化工作流范畴，与生成式 AI方向下的[AI智能体与生成工作流]规范子主题高度匹配。
...
### [70] [Differentially Private Preference Data Synthesis for Large Language Model Alignment](https://arxiv.org/abs/2605.30808)
...
Classification reason: 该论文提出差分隐私合成偏好数据生成方法，属于合成训练数据生成范畴，与 生成式 AI 方向下的 [CANONICAL] 子主题"合成数据与数据集蒸馏"高度匹配。同时涉及 LLM 对齐（generation_alignment）和隐私保护，但核心贡献是合成数据生成。
...
### [71] [A Padding Method for Enhanced Encoding of Inorganic Structures with Varying Chemical Compositions](https://arxiv.org/abs/2605.30743)
...
Classification reason: 该论文关注无机材料结构的生成式建模与编码，属于科学/材料领域的垂直生成应用，与 [CANONICAL] 子主题 "领域内容生成应用" (domain_application) 高度匹配。
...
### [72] [BlueFin: Benchmarking LLM Agents on Financial Spreadsheets](https://arxiv.org/abs/2605.30907)
...
Classification reason: 该论文提出了一个针对金融领域电子表格任务的 LLM 智能体评测基准 BlueFin，属于 生成式 AI 方向下的评测与基准（evaluation_benchmark）[CANONICAL] 子主题，因为其核心贡献是构建了包含 131 个复杂任务的评测数据集和评估框架。
...
### [73] [AnchorSteer: Self-Discovered Concept Injection for Structure-Preserving Music Editing](https://arxiv.org/abs/2605.31053)
...
Classification reason: 该论文研究可控音乐编辑（音频编辑），属于生成式 AI方向下的"视频音频生成应用"（video_audio_creation）规范子主题，该子主题涵盖音视频编辑与内容创作应用。同时与多模态生成方向下的"音频与多模态联合生成"（audio_av_generation）也相关，但主要侧重编辑应用而非基础生成方法。
...
### [74] [Latent Space Disentanglement via Activation Steering for Interpretable Attribute Control in Symbolic Music Generation](https://arxiv.org/abs/2605.31295)
...
Classification reason: 该论文研究符号音乐生成中的可解释属性控制，属于创意与艺术生成范畴，与 [CANONICAL] creative_art（创意与艺术生成）高度匹配。
...
### [75] [OmniMem: Scalable and Adaptive Memory Retrieval for Long Video Generation](https://arxiv.org/abs/2605.30519)
...
### [76] [LVSA: Training-Free Sparse Attention for Long Video Diffusion](https://arxiv.org/abs/2605.31057)
...
### [77] [Zeroth-Order Non-Log-Concave Sampling with Variance Reduction and Applications to Inverse Problems](https://arxiv.org/abs/2605.30573)
...
### [79] [Are Full Rollouts Necessary for On-Policy Distillation?](https://arxiv.org/abs/2605.31490)
...
### [80] [Fixed-Point Masked Generative Modeling](https://arxiv.org/abs/2605.31215)
...
### [81] [Toward Identifiable Sparse Autoencoders](https://arxiv.org/abs/2605.31245)
...
### [82] [Configurable Reward Model for Balanced Safety Alignment](https://arxiv.org/abs/2605.30487)
...
Classification reason: 该论文提出可配置的安全奖励模型（CSRM），用于大语言模型的安全对齐，核心贡献在于奖励建模与安全对齐。该主题与 [CANONICAL] subtopic "生成模型对齐与奖励"（generation_alignment）高度匹配，该 subtopic 在 生成式 AI、multimodal_generation、multimodal_understanding_generation 三个方向下均有收录，因此选择该已有 subtopic。
...
### [83] [Calibrated Preference Learning: The Case of Label Ranking](https://arxiv.org/abs/2605.30447)
...
Importance reason: Focuses on label ranking calibration, not aligned with user's priority subtopics in multimodal generation or 生成式 AI. Signals: Label ranking calibration, RLHF reward models, Not multimodal generation, Not autoregressive video/image generation, Not continuous VLM
...
### [84] [Pairwise Reference Alignment as a Model-Level Ordinal Observable](https://arxiv.org/abs/2605.30758)
*Mujing Li*
...
Classification reason: 该论文研究成对偏好数据下的模型对齐度量（pairwise reference alignment），核心是定义模型评分与参考偏好排序一致性的统计量，属于生成模型对齐与偏好优化的基础理论问题。该主题与 multimodal_generation 和 生成式 AI 方向下的 [CANONICAL] subtopic "generation_alignment（生成模型对齐与奖励）" 高度匹配，因此复用该 subtopic。
...
### [86] [The Flip Side of RLHF: On-Policy Feedback for Reward Model Self-Supervised Improvement](https://arxiv.org/abs/2605.30888)
...
### [87] [Federated Variational Preference Alignment with Gumbel-Softmax Prior for Personalized User Preferences](https://arxiv.org/abs/2605.30873)
...
Classification reason: 该论文提出联邦变分偏好对齐框架 FedVPA-GP，核心是解决联邦学习中 LLM 对齐时用户偏好冲突与个性化问题，属于生成模型对齐与偏好优化方向。该方向在 multimodal_generation 和 生成式 AI 下均有 canonical subtopic "generation_alignment"（生成模型对齐与奖励），且 生成式 AI 下也有同名 subtopic，因此复用该 subtopic。
...
### [89] [A Unifying View of Variational Generative Wasserstein Flows](https://arxiv.org/abs/2605.31369)
...
### [90] [Trust-Region Behavior Blending for On-Policy Distillation](https://arxiv.org/abs/2605.31159)
...
### [91] [Count Anything](https://arxiv.org/abs/2605.30846)
...
Classification reason: 该论文构建了跨域大规模目标计数数据集 CLOC 并提出通用计数模型 Count Anything，属于生成模型评测与数据集方向（generation_benchmark），因为其核心贡献之一是统一多领域数据源构建新基准数据集，同时涉及跨域泛化评测。此外，该工作也属于 生成式 AI 领域内容生成应用方向（domain_application），因为其面向农业、医学、遥感等多领域计数应用。
...
### [92] [GraphARC: A Comprehensive Benchmark for Graph-Based Abstract Reasoning](https://arxiv.org/abs/2605.31031)
...
### [93] [Benchmarking and Enhancing Text-to-Image Models for Generating Visual Representations in Early Arithmetic Education](https://arxiv.org/abs/2605.31212)
...
Classification reason: 该论文提出基于共形预测的生成模型可靠性评估指标，属于生成模型评测范畴。multimodal_generation 方向下的 [CANONICAL] subtopic "generation_benchmark"（生成模型评测与数据集）完美匹配，因为该 subtopic 明确包含"自动评测指标"和"评估"。同时该工作也涉及 生成式 AI 评测。
...
### [95] [3DAE: Binaural Quality Assessment for Audio Novel View Synthesis with Spatial Maps and Benchmark](https://arxiv.org/abs/2605.30469)
*Jialu Xu, Yifan Zhou*
...
### [96] [MergeTok: Unified Continuous and Discrete Visual Tokenization via Token Merging](https://arxiv.org/abs/2605.30904)
...
### [98] [SLAP: The Semantic Least Action Principle for Variational Video-Language Modeling](https://arxiv.org/abs/2605.30750)
...
### [99] [Robust Dreamer: Deviation-Aware Latent Gaussian Memory for Action-Controlled AR Video Generation](https://arxiv.org/abs/2605.30855)
...
Classification reason: 该论文提出动作控制的图像到视频生成框架用于交互式世界模拟，属于视频世界模型（video_world_model）这一[CANONICAL]子主题。同时涉及生成式 AI方向下的视频生成应用。
...
### [100] [Physically Viable World Models: A Case for Query-Conditioned Embodied AI](https://arxiv.org/abs/2605.30542)
...
### [101] [Light Interaction: Training-Free Inference Acceleration for Interactive Video World Models](https://arxiv.org/abs/2605.31158)
...
### [102] [Probabilistic Precipitation Nowcasting with Rectified Flow Transformers](https://arxiv.org/abs/2605.31204)
...
### [103] [PatchWorld: Gradient-Free Optimization of Executable World Models](https://arxiv.org/abs/2605.30880)
...
### [104] [DecMem: Towards Minute-Long Consistent World Generation with Decoupled Memory](https://arxiv.org/abs/2605.31336)
...
### [105] [Subspace-Decomposed JEPAs: Disentangling Progression and Content in Latent World Models](https://arxiv.org/abs/2605.31111)
...
### [106] [Towards Streaming Synchronized Spatial Audio Generation via Autoregressive Diffusion Transformer](https://arxiv.org/abs/2605.30940)
...
### [107] [Chatterbox-Flash: Prior-Calibrated Block Diffusion for Streaming Zero-Shot TTS](https://arxiv.org/abs/2605.30748)
...
Classification reason: 该论文提出零样本文本到语音（TTS）生成模型，属于音频生成方向，与多模态生成方向下的 [CANONICAL] subtopic "音频与多模态联合生成"（audio_av_generation）高度匹配。同时该工作也属于生成式 AI范畴。
...
### [108] [ImmersiveTTS: Environment-Aware Text-to-Speech with Multimodal Diffusion Transformer and Domain-Specific Representation Alignment](https://arxiv.org/abs/2605.30965)
...
### [109] [Hide-and-Seek in Trajectories: Discovering Failure Signals for VLA Runtime Monitoring](https://arxiv.org/abs/2605.30834)
...
### [111] [Immuno-VLM: Immunizing Large Vision-Language Models via Generative Semantic Antibodies for Open-World Trustworthiness](https://arxiv.org/abs/2605.30745)
...
### [112] [What Makes LVLMs Hallucinate Less? Unveiling the Architectural Factors Behind Hallucination Robustness](https://arxiv.org/abs/2605.30911)
...
### [113] [Human-Alignment, Calibration, and Activation Patterns in Large Language Model Uncertainty](https://arxiv.org/abs/2605.30675)
...
### [114] [Learning from Fine-Grained Visual Discrepancies: Mitigating Multimodal Hallucinations via In-Context Visual Contrastive Optimization](https://arxiv.org/abs/2605.31312)
...
### [115] [YARD: Y-Architecture Register Decoding for Efficient Hallucination Mitigation in Large Vision-Language Models](https://arxiv.org/abs/2605.31429)
...
### [116] [BenHalluEval: A Multi-Task Hallucination Evaluation Framework for Large Language Models on Bengali](https://arxiv.org/abs/2605.31483)
...
### [117] [Attend to Evidence: Evidence-Anchored Spatial Attention Supervision for Multimodal RLVR](https://arxiv.org/abs/2605.30912)
...
### [118] [Diversity Matters: Revisiting Test-Time Compute in Vision-Language Models](https://arxiv.org/abs/2605.30713)
...
### [120] [iVGR: Internalizing Visually Grounded Reasoning for MLLMs with Reinforcement Learning](https://arxiv.org/abs/2605.31096)
...
### [121] [LARK: Learnability-Grounded Trajectory Selection for Efficient Reasoning Distillation](https://arxiv.org/abs/2605.30651)
...
### [122] [The Sword, Shield, and Achilles' Heel: Characterizing the Linguistic Inductive Bias of Large Language Models for Spatial Reasoning in Navigation Planning](https://arxiv.org/abs/2605.31404)
...
### [123] [LongTraceRL: Learning Long-Context Reasoning from Search Agent Trajectories with Rubric Rewards](https://arxiv.org/abs/2605.31584)
...
### [124] [Variational Adapter for Cross-modal Similarity Representation](https://arxiv.org/abs/2605.30968)
...
### [125] [FOCUS: Forcing In-Context Object Localization through Visual Support Constraints and Policy Optimization](https://arxiv.org/abs/2605.31145)
...
### [126] [Beyond Classification: Dynamic Adapter Routing for Continual Multimodal Retrieval](https://arxiv.org/abs/2605.31229)
...
### [127] [Inference-Free Multimodal Learned Sparse Retrieval for Production-Scale Visual Document Search](https://arxiv.org/abs/2605.30917)
...
### [128] [FBHM: Functional Benchmarking and Steering of VLMs for Hateful Meme Detection](https://arxiv.org/abs/2605.31349)
...
Classification reason: 该论文提出了FBHM基准，系统性地构建了基于功能的有害模因检测基准，并对多种VLM进行了评测，揭示了泛化差距。这属于多模态评测与基准（multimodal_benchmark）这一[CANONICAL]子主题。同时，有害模因检测也涉及生成式 AI安全治理方向。
...
### [129] [Seeing Isn't Knowing: Do VLMs Know When Not to Answer Spatial Questions (and Why)?](https://arxiv.org/abs/2605.30557)
...
### [130] [PInVerify: An Offline Embodied Benchmark for Active Instance Verification](https://arxiv.org/abs/2605.30639)
*Yuhang Jiang*
...
### [131] [BilliardPhys-Bench: Benchmarking Physical Reasoning and Visual Dynamics of Multimodal LLMs](https://arxiv.org/abs/2605.30900)
...
### [132] [Does Visual Information Play a Decisive Role in Vision-Language-Action Model Driving Behavior?](https://arxiv.org/abs/2605.31041)
...
### [133] [TeachObs: A Human-Validated Benchmark for Multimodal Teaching Observation and Model Evaluation](https://arxiv.org/abs/2605.30673)
...
Classification reason: 该论文提出了一个针对课堂教学视频的多模态评测基准 TeachObs，包含细粒度标注和课程级评估，属于多模态评测与基准（multimodal_benchmark）这一规范主题。同时该基准涉及 生成式 AI 模型（LLM）的评估，也匹配 生成式 AI 评测与基准（evaluation_benchmark）。
...
### [134] [FAM-Bench: A Multimodal Benchmark for Condition-Aware Food-as-Medicine Reasoning](https://arxiv.org/abs/2605.31410)
...
### [135] [Probing Collision Grounding in Vision-Language Models for Safe Human-Robot Collaboration](https://arxiv.org/abs/2605.31196)
...
Classification reason: 该论文提出了TouchSafeBench，一个用于评估VLM碰撞接地能力的物理仿真基准，属于多模态评测与基准（multimodal_benchmark）这一[CANONICAL]子主题。同时涉及机器人安全监控，也匹配生成式 AI方向下的生成内容安全与治理（safety_governance）。
...
### [136] [ERGeoBench:A Comprehensive Benchmark for Embodied Reasoning and Geo-localization in Multimodal Large Language Models](https://arxiv.org/abs/2605.31251)
...
### [137] [MineExplorer: Evaluating Open-World Exploration of MLLM Agents in Minecraft](https://arxiv.org/abs/2605.30931)
...
Classification reason: 该论文提出了 MineExplorer 基准，用于评估 MLLM 智能体在 Minecraft 开放世界中的探索能力，属于多模态评测与基准（multimodal_benchmark）这一规范主题。同时涉及 生成式 AI 方向下的 AI 智能体与生成工作流（agent_workflow），因为使用了多智能体合成工作流来构建评测实例。
...
### [138] [On the Robustness of Multilingual Text Embedding Rankings Across Learning Tasks, Languages, and Benchmark Datasets](https://arxiv.org/abs/2605.31142)
...
### [139] [SVI-Bench: A Dynamic Microworld for Strategic Video Intelligence](https://arxiv.org/abs/2605.31529)
...
### [140] [EGOSTREAM: A Diagnostic Benchmark for Streaming Episodic Memory in Egocentric Vision](https://arxiv.org/abs/2605.31557)
...
### [141] [nuReasoning: A Reasoning-Centric Dataset and Benchmark for Long-Tail Autonomous Driving](https://arxiv.org/abs/2605.31572)
...
### [142] [Recognizing Co-Speech Gestures in-the-Wild](https://arxiv.org/abs/2605.31589)
...
### [143] [SOCO: Benchmarking Semantic Object Correspondence in Vision Foundation Models](https://arxiv.org/abs/2605.31597)
...
### [144] [A Visually Impaired Assistance Benchmark for VLM-as-a-Judge Evaluation](https://arxiv.org/abs/2605.31351)
...
Classification reason: 该论文提出了 VIABLE，首个面向视障辅助（VIA）场景的 VLM-as-a-Judge 评测基准，属于多模态评测与基准（multimodal_benchmark）这一 [CANONICAL] 子主题。同时涉及 生成式 AI 评测（evaluation_benchmark）方向，因为其核心是评估生成式 VLM 作为评判者的可靠性。
...
### [145] [TRINE: A Token-Aware, Runtime-Adaptive FPGA Inference Engine for Multimodal AI](https://arxiv.org/abs/2603.22867)
...
### [147] [Linear Scaling Video VLMs for Long Video Understanding](https://arxiv.org/abs/2605.31598)
...
### [148] [A Pilot Study on Curator-Guided Multilingual Art Description for Blind and Low-Vision Audiences with Small Vision-Language Models](https://arxiv.org/abs/2605.31080)
...
Classification reason: 该论文研究策展人引导的多语言艺术描述生成，面向盲人和低视力观众，属于垂直领域（博物馆/艺术）的内容生成应用。该主题与现有 subtopic "领域内容生成应用"（domain_application）高度匹配，该 subtopic 在 multimodal_understanding_generation 和 生成式 AI 方向下均有收录。
...
### [149] [Rationalize: Shared Semantic Reasoning for Human-AI Alignment](https://arxiv.org/abs/2605.30632)
...
Classification reason: 该论文提出 Rationalize 框架，将人机交互建模为互补角色对（Explorer-Guide, Investigator-Informant, Teacher-Student, Judge-Advocate），在共享推理空间中实现人类与 AI（如 LLM）的对齐。这属于 AI 智能体与生成工作流（agent_workflow）范畴，涉及 LLM 智能体协作、人机对齐与交互工作流设计。同时与多模态理解与生成方向下的对齐主题相关。
...
### [150] [Simple Token-Efficient Vision-Language Model for Case-level Pathology Synoptic Report Generation](https://arxiv.org/abs/2605.30716)
...
Classification reason: 该论文聚焦于病理学全切片图像的结构化报告生成，属于医疗垂直领域的生成应用，与现有 subtopic "领域内容生成应用"（domain_application）高度匹配。该 subtopic 在 multimodal_understanding_generation 和 生成式 AI 方向下均有存在，且为 CANONICAL 条目。
...
### [151] [GUI-C$^2$: Coarse-to-Fine GUI Grounding via Difficulty-Aware Reinforcement Learning](https://arxiv.org/abs/2605.30884)
...
Classification reason: 该论文研究 GUI 智能体中的视觉定位（GUI grounding），属于多模态理解与生成方向下的 AI 智能体与生成工作流（agent_workflow）范畴。论文提出的粗到细定位机制和强化学习训练策略属于智能体工作流优化，与现有 canonical subtopic 高度匹配。
...
### [152] [Harness Updating Is Not Harness Benefit: Disentangling Evolution Capabilities in Self-Evolving LLM Agents](https://arxiv.org/abs/2605.30621)
...
Classification reason: 该论文研究 LLM 智能体的自演化能力，分析智能体在提示、技能、记忆和工具等外部 harness 上的更新能力与收益能力，属于 AI 智能体与生成工作流范畴，与 [CANONICAL] subtopic agent_workflow 高度匹配。
...
### [153] [Generating Reports or Repeating Templates? Measuring and Mitigating Template Collapse in 3D CT Report Generation](https://arxiv.org/abs/2605.30984)
...
Classification reason: 该论文研究3D CT影像报告生成，属于医疗垂直领域的生成应用，与现有 canonical subtopic "domain_application"（领域内容生成应用）高度匹配。同时涉及多模态理解与生成（3D医学VLM），因此主方向为 multimodal_understanding_generation，也匹配 生成式 AI。
...
### [154] [The Architecture of Errors: From Universal Impossibility to Patch-Local LLM Reliability](https://arxiv.org/abs/2605.30628)
...
Classification reason: 该论文从理论层面论证了LLM可靠性问题的本质，提出在操作有界补丁（如法律审查、医疗RAG等）内，失败模式是稀疏且可重复的，从而将可靠性转化为局部目录发现与干预覆盖问题。这属于对生成式 AI系统（尤其是LLM生成内容）的可靠性评测与理论分析，与生成式 AI评测与基准方向高度相关。
...
### [155] [Planner-Centric Reinforcement Learning for Deep Research with Structure-Aware Reward](https://arxiv.org/abs/2605.30824)
...
### [156] [COMPASS: Cognitive MCTS-Guided Process Alignment for Safe Search Agents](https://arxiv.org/abs/2605.30838)
...
Classification reason: 该论文关注 LLM 搜索智能体在多步推理中的安全对齐问题，属于 生成式 AI 方向下的生成内容安全与治理（safety_governance）范畴，同时涉及多步交互中的安全对齐，也与多模态理解与生成方向下的多模态安全与攻防（multimodal_safety_attack）相关。
...
### [157] [UniScale: Adaptive Unified Inference Scaling via Online Joint Optimization of Model Routing and Test-Time Scaling](https://arxiv.org/abs/2605.30898)
...
Classification reason: 该论文提出UniScale框架，将模型路由（在不同规模LLM间切换）与测试时扩展（TTS）统一为在线联合优化问题，属于LLM推理工作流的自动化与智能调度，与生成式 AI方向下的"AI智能体与生成工作流"（agent_workflow）高度匹配。
...
### [158] [Task-Focused Memorization for Multimodal Agents](https://arxiv.org/abs/2605.31075)
...
Classification reason: 该论文研究多模态智能体的长期记忆生成策略，属于多模态智能体（multimodal agent）工作流范畴。在 multimodal_understanding_generation 方向下，agent_workflow（AI 智能体与生成工作流）是唯一匹配的 [CANONICAL] 子主题，涵盖 LLM 智能体、工具使用、自动化流水线等。同时该论文也涉及 生成式 AI 方向下的智能体工作流。
...
### [159] [ExpGraph: Model-Agnostic Experience Learning with Graph-Structured Memory for LLM Agents](https://arxiv.org/abs/2605.30712)
...
Classification reason: 该论文提出 ExpGraph，一种模型无关的经验学习框架，使 LLM 智能体能够通过外部经验图重用成功策略和失败教训，属于 LLM 智能体与生成工作流方向，因此映射到 生成式 AI 下的 [CANONICAL] 子主题 "AI 智能体与生成工作流"。
...
### [160] [Learning to Adapt: Self-Improving Web Agent via Cognitive-Aware Exploration](https://arxiv.org/abs/2605.31365)
...
Classification reason: 该论文提出 SCALE 框架，通过三个对抗性角色（Selector, Predictor, Judger）和图探索策略 SCALE-Hop 实现 Web 智能体的自主探索与自我改进，属于 LLM 智能体与自动化工作流范畴，因此映射到 [CANONICAL] agent_workflow。
...
### [161] [Counterfactual Evaluation Reveals Hidden Capability Profiles in Clinical LLMs and Agents](https://arxiv.org/abs/2605.30590)
*Matt Turk*
...
Classification reason: 该论文提出了一种新的因果敏感性评分（CSS）来评估临床LLM和智能体的响应能力，属于生成式 AI评测与基准范畴。CSS是一种干预式评测指标，用于评估模型在临床输入变化时是否更新其推荐，这与生成式 AI评测与基准（evaluation_benchmark）高度匹配。同时，论文涉及临床LLM和智能体，也与多模态理解与生成方向相关。
...
### [162] [Detect in Any Scene: An Agentic Framework for Object Detection with Experience-Aware Reasoning](https://arxiv.org/abs/2605.31174)
...
Classification reason: 该论文提出 DetAS，一个基于 MLLM 作为中央智能体的目标检测框架，通过动态组合恢复模块和专用检测器来构建检测工作流，属于 LLM 智能体与自动化工作流范畴。虽然该论文聚焦于目标检测而非内容生成，但其核心思想——利用 MLLM 智能体动态编排工具和工作流——与 agent_workflow（AI 智能体与生成工作流）高度契合，且该 subtopic 在 multimodal_understanding_generation 方向下已有收录。
...
### [163] [The Regularizing Power of Language-Training Deepfake Detectors](https://arxiv.org/abs/2605.31192)
...
Classification reason: 该论文研究深度伪造检测（deepfake detection），属于 生成式 AI 检测与溯源这一 [CANONICAL] 子主题的核心范畴。同时涉及 MLLM 用于检测，因此也匹配多模态理解与生成方向。
...
### [164] [Wind Turbine Maintenance Log Labelling Framework: LLM-Driven Data Correction and Enrichment via Semantic Extraction of Reliability Intelligence](https://arxiv.org/abs/2605.31281)
...
Classification reason: 该论文研究对抗性补丁（adversarial patches）在真实场景下的鲁棒性评估框架，属于AI安全与对抗攻击评估范畴。生成式 AI方向下的[CANONICAL] subtopic "生成内容安全与治理"（safety_governance）涵盖内容安全、有害内容检测等，对抗性补丁评估是AI安全治理的重要组成部分，因此归入该方向。
...
### [166] [Preference-Aware Rubric Learning for Personalized Evaluation](https://arxiv.org/abs/2605.31545)
...
Classification reason: 该论文研究个性化评估方法，属于生成式 AI评测范畴，与[生成式 AI 评测与基准]（evaluation_benchmark）高度匹配。同时涉及个性化对齐评估，也与多模态理解与生成方向相关。

Importance reason: Focuses on personalized evaluation for text generation, which is outside the user's core interests in multimodal generation and video/image generation. Signals: 生成式 AI evaluation, personalized alignment, rubric learning, text generation, no multimodal or video/image focus
...
### [167] [EvoDefense: Co-Evolving Black-Box Defense with Large Language Models](https://arxiv.org/abs/2605.31140)
...
Classification reason: 该论文提出针对LLM黑盒攻击的防御方法，属于生成内容安全与治理范畴，与生成式 AI方向下的[CANONICAL]子主题"生成内容安全与治理"（safety_governance）高度匹配。
...
### [168] [Fighting Numerical Hallucinations via Data-centric Compilation for Online Financial QA](https://arxiv.org/abs/2605.31064)
...
Classification reason: 该论文聚焦金融领域问答中的数值幻觉问题，属于垂直领域（金融）的生成应用，与 [CANONICAL] 的"领域内容生成应用"（domain_application）高度匹配。
...
### [169] [DeMaVLA: A Vision-Language-Action Foundation Model for Generalizable Deformable Manipulation](https://arxiv.org/abs/2605.31286)
...
Classification reason: 该论文提出 DeMaVLA，一个面向可变形物体操作的 VLA（视觉-语言-动作）基础模型，属于机器人操作智能体范畴。论文涉及 VLM 骨干、动作生成（flow matching）、数据聚合（DAgger）等工作流，与 [CANONICAL] subtopic "AI 智能体与生成工作流"（agent_workflow）高度匹配。该 subtopic 在 multimodal_understanding_generation 方向下已有记录，因此直接复用。
...
### [170] [Send a SCOUT First: Pre-hoc Reasoning for Adaptive Detector Allocation in Prompt-Injection Defense](https://arxiv.org/abs/2605.30837)
...
Classification reason: 该论文研究提示注入攻击的防御策略，属于生成内容安全与治理范畴，与 canonical 子主题 safety_governance（生成内容安全与治理）高度匹配。
...
### [171] [VLM3: Vision Language Models Are Native 3D Learners](https://arxiv.org/abs/2605.30561)
...
### [172] [SpatialAct: Probing Spatial Reasoning-to-Action Capabilities of VLM Agents in 3D Scenes](https://arxiv.org/abs/2605.31148)
...
### [174] [VLM-GLoc: Vision-Language Model Enhanced Monte Carlo Localization for Robust Semantic Global Localization in Cluttered Quasi-Static Environments](https://arxiv.org/abs/2605.30506)
...
### [175] [Representation Forcing for Bottleneck-Free Unified Multimodal Models](https://arxiv.org/abs/2605.31604)
...
### [176] [How can embedding models bind concepts?](https://arxiv.org/abs/2605.31503)
...
### [177] [Personalize Your Large Vision-language Models With In-context Prompt Tuning](https://arxiv.org/abs/2605.31513)
...
### [178] ["Intelegi Româneşte?'' A Recipe for Romanian Vision-Language Models](https://arxiv.org/abs/2605.31401)
...
### [179] [Seeing Before Agreeing: Aligning Multi-Agent Consensus with Visual Evidence](https://arxiv.org/abs/2605.30698)
...
### [180] [Annotations Are Not All You Need: A Cross-modal Knowledge Transfer Network for Unsupervised Temporal Sentence Grounding](https://arxiv.org/abs/2605.30742)
...
### [181] [MechVQA: Benchmarking and Enhancing Multimodal LLMs on Comprehensive Mechanical Drawing Understanding](https://arxiv.org/abs/2605.30794)
...
### [182] [DisasterLex: An Expert Concept-to-Schema Knowledge Graph for Geospatial Reasoning in Disaster Analytics](https://arxiv.org/abs/2605.30538)
...
### [183] [WristCompass: Kinematic Coupling as a Learnable Visual Concept for Ego-Camera Orientation](https://arxiv.org/abs/2605.30671)
...
### [184] [PEEK: Picking Essential frames via Efficient Knowledge distillation](https://arxiv.org/abs/2605.31029)
...
### [185] [Towards Effective Long-Video Event Prediction via Multi-Level Event Semantics Mining](https://arxiv.org/abs/2605.31069)
...
### [186] [HiERO-StepG @ Ego4D Step Grounding Challenge: hierarchical activity understanding enables zero-shot step grounding](https://arxiv.org/abs/2605.31227)
...
### [187] [Sound effects in media:A comparative analysis of recorded and synthetic samples in live-action and animation](https://arxiv.org/abs/2605.31082)
...
Classification reason: 该论文研究程序化音频（数字拟音）在影视和动画中的合成音效与真实录音的对比感知，属于生成式 AI方向下的音视频内容创作应用。现有[CANONICAL] subtopic "视频音频生成应用"（video_audio_creation）涵盖视频后期、音视频编辑、内容创作产品级生成应用，与本论文主题高度匹配。
...
### [188] [UXR PoV for Neuroinclusive Emotion Regulation](https://arxiv.org/abs/2605.31131)
...
Classification reason: 该论文将生成式AI应用于数字心理健康领域（ADHD情绪调节干预设计），属于垂直领域生成应用，与 canonical 子主题"领域内容生成应用"（domain_application）高度匹配。
...
### [189] [Extending the UXR Point of View Pyramid: A Generative AI-Augmented Methodology for Human-Centred AI Systems](https://arxiv.org/abs/2605.31143)
...
Classification reason: 该论文将生成式AI嵌入到用户体验研究（UXR）工作流中，提出AI增强的UXR PoV金字塔和Playbook Card系统，属于AI智能体与生成工作流（agent_workflow）范畴。
...
### [190] [Personalized to Persuade: The Effects of Contextualization and Warmth on Trust and Reliance in Conversational AI](https://arxiv.org/abs/2605.31275)
...
Classification reason: 该论文研究对话式AI中个性化（contextualization）与温暖感（warmth）对用户信任和依赖的影响，属于生成式 AI方向下的个性化与对话生成（personalization_persona）这一规范主题，因为其核心关注个性化助手对话设计及其对用户行为的影响。
...
### [191] [EUDAIMONIA: Evaluating Undesirable Dynamics in AI](https://arxiv.org/abs/2605.30654)
...
Classification reason: 该论文提出了一个评估LLM在社交交互中不良动态的基准（EUDAIMONIA），属于生成式 AI方向下的生成内容质量评测与安全评估范畴，与[CANONICAL] subtopic "生成式 AI 评测与基准"（evaluation_benchmark）高度匹配。
...
### [192] [Protocol for evaluating ChatGPT in biomedical association generation and verification using a RAG-enabled, cross-model majority voting workflow](https://arxiv.org/abs/2605.30400)
...
Classification reason: 该论文提出评估 ChatGPT 生成生物医学关联能力的协议，属于 生成式 AI 生成内容的质量评测范畴，与 [CANONICAL] 子主题 "生成式 AI 评测与基准" 高度匹配。
...
### [193] [MAAT: Multi-phase Adapter-Aware Targeted Unlearning](https://arxiv.org/abs/2605.30514)
...
Classification reason: 该论文研究机器遗忘（machine unlearning），属于 生成式 AI 方向下的"概念擦除与遗忘学习"（unlearning_erasure）这一规范子主题。论文提出了针对因果知识的遗忘方法 MAAT 和评测基准 5WBENCH，核心是模型遗忘与知识保留的权衡，与子主题定义完全吻合。
...
### [194] [Same Patient, Different Words, Different Diagnosis? Evaluating Semantic Stability in Clinical LLMs](https://arxiv.org/abs/2605.30646)
...
Classification reason: 该论文研究临床LLM在语义等价改写下的稳定性与鲁棒性，属于医疗垂直领域的大语言模型应用评估，与生成式 AI方向下的[领域内容生成应用]（domain_application）高度匹配。
...
### [195] [Counterfactual Graph for Multi-Agent LLM Calibration](https://arxiv.org/abs/2605.30653)
...
Classification reason: 该论文研究多智能体LLM系统的校准与可靠性问题，属于LLM智能体工作流范畴，与[生成式 AI]方向下的[AI智能体与生成工作流]（agent_workflow）高度匹配。
...
### [196] [ElasticMem: Latent Memory as a Learnable Resource for LLM Agents](https://arxiv.org/abs/2605.30690)
...
Classification reason: 该论文提出 ElasticMem，一种为 LLM 智能体设计的可学习弹性记忆框架，核心是增强智能体的长期记忆与推理能力。这与 [CANONICAL] 子主题 "AI 智能体与生成工作流"（agent_workflow）高度匹配，该子主题涵盖 LLM 智能体、工作流、工具使用等方向。
...
### [197] [Skill is Not One-Size-Fits-All: Model-Aware Skill Alignment for LLM Agents](https://arxiv.org/abs/2605.30723)
...
Classification reason: 该论文研究LLM智能体的技能对齐与自适应工作流，属于生成式 AI方向下的"AI智能体与生成工作流"（agent_workflow）规范子主题，该子主题涵盖LLM智能体、工作流、工具使用与自动化等核心内容。
...
Classification reason: 该论文提出 LLM-FACETS 框架，用于评估 LLM 输出的事实性、校准性和可复现性，属于 生成式 AI 生成内容质量评测范畴，与 [CANONICAL] subtopic "生成式 AI 评测与基准" 高度匹配。
...
### [199] [BIAS-ID: A Framework for Analyzing Transformation Biases in AI-Generated Image Detectors](https://arxiv.org/abs/2605.31153)
...
Classification reason: 论文研究AI生成图像检测器的变换偏差分析框架，属于生成式 AI检测方向，与[CANONICAL] subtopic "生成式 AI 检测与溯源"（detection_attribution）高度匹配。

Importance reason: Focuses on AI image detector bias analysis, not aligned with user's priority on generation models and multimodal understanding. Signals: 生成式 AI detection, transformation bias, forensic artifacts, detector robustness, spurious correlations
...
Classification reason: 该论文研究深度研究智能体在查询外部工具时泄露私有信息的隐私风险，属于生成式 AI安全与治理范畴。论文提出了MosaicLeaks基准和PA-DR框架来检测和缓解隐私泄露，与[CANONICAL] subtopic "生成内容安全与治理"（safety_governance）高度匹配。
...
Classification reason: 该论文提出 AutoSci，一个基于 LLM 的科研智能体系统，覆盖文献理解、实验、写作、审稿回复等完整科研工作流，属于 AI 智能体与自动化工作流方向，与 [CANONICAL] subtopic agent_workflow 高度匹配。
...
### [202] [Extending AI for Research to the Humanities: A Multi-Agent Framework for Evidence-Grounded Scholarship](https://arxiv.org/abs/2605.30947)
...
Classification reason: 该论文提出 SPIRE 多智能体框架，将人文学科研究操作（来源发现、证据标注、比较、溯源检查等）建模为协作智能体角色，属于 LLM 智能体与生成工作流方向，与 canonical 子主题 agent_workflow 高度匹配。
...
### [203] [Authentication of Copy Detection Patterns via Cross-Camera Dual-Synthetic Referencing](https://arxiv.org/abs/2605.31292)
...
Classification reason: 该论文研究 Copy Detection Patterns (CDP) 的认证方法，属于生成内容（印刷防伪图案）的检测与真伪鉴别，与 生成式 AI 检测与溯源（detection_attribution）方向高度吻合，因此复用该规范子主题。

Importance reason: Focuses on 生成式 AI detection and physical authentication, which is not a priority subtopic and lacks alignment with user's key interests in generation and multimodal models. Signals: 生成式 AI detection, cross-camera authentication, copy detection patterns, low personal relevance to generation or multimodal reasoning
...
### [204] [KnowledgeGain: Evaluating and Optimizing Science News Generation for Reader Learning](https://arxiv.org/abs/2605.31099)
...
Classification reason: 该论文提出 KnowledgeGain 指标，用于评估科学新闻生成内容对读者知识获取的效果，属于生成内容质量评测范畴，与 [CANONICAL] 子主题 evaluation_benchmark（生成式 AI 评测与基准）高度匹配。

Importance reason: Focuses on science news evaluation for reader learning, not on the user's priority subtopics like continuous VLM, autoregressive video generation, or world models. Signals: 生成式 AI evaluation metric, science news generation, reader knowledge gain, LLM simulator, not aligned with priority subtopics
...
### [205] [Beyond Accuracy: Evaluating Efficiency, Robustness and Explainability in Deep Learning for Malaria Diagnosis](https://arxiv.org/abs/2605.30734)
...
Classification reason: 该论文研究深度学习模型在疟疾诊断（医疗领域）中的应用，属于垂直领域内容生成应用，映射到现有 canonical 子主题 domain_application（领域内容生成应用）。
...
### [206] [An Organization-Scoped LLM Agent Runtime Architecture for Regulated Cybersecurity Operations](https://arxiv.org/abs/2605.30604)
...
### [207] [Reliable Multilingual Orthopedic Decision Support from Clinical Narratives: Language-Aware Adaptation and Verification-Guided Deferral](https://arxiv.org/abs/2605.31512)
...
Classification reason: 该论文聚焦于多语言骨科临床决策支持，属于医疗垂直领域的AI应用，与现有 canonical 子主题"领域内容生成应用"（domain_application）高度匹配。
...
### [208] [Learning Multi-Agent Coordination via Sheaf-ADMM](https://arxiv.org/abs/2605.31005)
...
Classification reason: 该论文提出了一种基于可微优化框架的多智能体协调方法，使用ADMM和细胞层（cellular sheaf）实现智能体间的约束协调。这属于AI智能体与生成工作流（agent_workflow）范畴，因为其核心是多智能体系统的协调与自动化工作流，且该方向已有116篇论文积累，是最佳匹配。
...
### [209] [GSAM: A Generalizable and Safe Robotic Framework for Articulated Object Manipulation](https://arxiv.org/abs/2605.30740)
...
Classification reason: 该论文提出面向铰接物体操作的机器人框架GSAM，属于机器人操作这一垂直领域应用。虽然论文涉及VLM/LLM推理，但其核心是机器人操作任务，映射到生成式 AI方向下的"领域内容生成应用"（domain_application）最为合适，该子主题涵盖垂直领域生成应用。
...
### [210] [Forgetting Has Neighbors: Localized Collateral Forgetting in Machine Unlearning](https://arxiv.org/abs/2605.31317)
...
Classification reason: 该论文研究机器遗忘（machine unlearning），属于概念擦除与遗忘学习（unlearning_erasure）这一规范子主题的核心范畴。论文分析了遗忘过程中的局部附带遗忘现象并提出缓解策略，与现有子主题定义高度吻合。
...
### [211] [Knowledge Boundary Probing and Demand-Guided Intervention for LLM-Based Power System Code Generation](https://arxiv.org/abs/2605.31478)
