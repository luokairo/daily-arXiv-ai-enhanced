...
- [多模态生成](#direction-multimodal_generation) [Total: 67]
...
- [AIGC](#direction-aigc) [Total: 81]
  - [AI 智能体与生成工作流](#direction-aigc-aigc_agent_workflow) [Total: 18]
  - [AIGC 检测与溯源](#direction-aigc-aigc_detection_attribution) [Total: 5]
  - [AIGC 评测与基准](#direction-aigc-aigc_evaluation_benchmark) [Total: 19]
  ...
  - [生成内容安全与治理](#direction-aigc-aigc_safety_governance) [Total: 12]
  - [生成模型对齐与奖励](#direction-aigc-generation_alignment) [Total: 1]
  - [视频音频生成应用](#direction-aigc-aigc_video_audio_creation) [Total: 2]
  - [领域内容生成应用](#direction-aigc-aigc_domain_application) [Total: 13]
- [多模态理解与生成](#direction-multimodal_understanding_generation) [Total: 65]
...
Classification reason: 论文聚焦于3D Gaussian Splatting场景中的物体移除与修复方法评测，属于3D场景生成与重建范畴，与[多模态生成]方向下的[3D 生成与重建]（CANONICAL）高度匹配。同时涉及AIGC方向下的生成内容评测，但核心贡献在3DGS场景修复，故主方向为多模态生成。
...
### [11] [Functional MRI Time Series Generation via Wavelet-Based Image Transform and Spectral Flow Matching for Brain Disorder Identification](https://arxiv.org/abs/2605.30387)
...
Classification reason: 该论文使用生成模型合成fMRI时间序列数据以增强下游脑疾病分类任务，属于合成训练数据生成范畴，映射到multimodal_generation方向下的aigc_synthetic_data（合成数据与数据集蒸馏）子主题。
...
### [12] [GGT-100K: Generative Ground Truth for Generalizable Real-World Image Restoration](https://arxiv.org/abs/2605.31039)
...
Classification reason: 该论文利用多模态基础模型（MFMs）从真实低质量图像生成高质量目标，构建了GGT-100K合成配对数据集用于图像复原训练，属于合成训练数据生成范畴，因此映射到[CANONICAL] subtopic "合成数据与数据集蒸馏"（aigc_synthetic_data）。该subtopic同时存在于multimodal_generation和aigc两个方向下。
...
### [13] [SANA-Streaming: Real-time Streaming Video Editing with Hybrid Diffusion Transformer](https://arxiv.org/abs/2605.30409)
...
Classification reason: 该论文研究实时流式视频到视频编辑（V2V），属于多模态生成方向下的图像与视频编辑（visual_editing）这一[CANONICAL]子主题，同时涉及AIGC方向下的视频音频生成应用（aigc_video_audio_creation）。
...
### [14] [DTG-Restore: Training-Free Diffusion Refinement for Generative Video Super-Resolution](https://arxiv.org/abs/2605.30431)
...
### [15] [Mitigating Content Shift and Hallucination in GenAI Image Editing via Structural Refinement](https://arxiv.org/abs/2605.30437)
...
### [16] [Guidance for Low-Level Perceptual Editing in Unconditional Diffusion Models](https://arxiv.org/abs/2605.31162)
...
### [17] [Dex2HOI: Dexterous Bimanual Two-Object Interaction Generation](https://arxiv.org/abs/2605.30444)
...
### [18] [MultiAct: Text-to-Motion Generation from Composite Text via Tailored Attention Guidance](https://arxiv.org/abs/2605.30925)
...
### [19] [Omni-Supervised Motion Editing: Balancing Change and Invariance through Positive-Negative Learning](https://arxiv.org/abs/2605.30969)
...
### [20] [Polyphony: Diffusion-based Dual-Hand Action Segmentation with Alternating Vision Transformer and Semantic Conditioning](https://arxiv.org/abs/2605.31115)
...
### [21] [GSAM: A Generalizable and Safe Robotic Framework for Articulated Object Manipulation](https://arxiv.org/abs/2605.30740)
...
### [22] [TokTalk: Expressive Real-time Facial Animation from Audio-LLM Tokens](https://arxiv.org/abs/2605.31294)
...
Classification reason: 该论文从音频LLM的音频token直接实时生成3D面部动画（说话头/虚拟人面部表情），属于多模态生成方向下的[CANONICAL]数字人与动作生成（avatar_motion_generation）子主题，同时与AIGC方向下的视频音频生成应用（aigc_video_audio_creation）也相关。
...
### [23] [SMART: SMPLest-X Mesh Adaptation and RAFT Tracking for Soccer Pose Estimation](https://arxiv.org/abs/2605.31551)
*Parthsarthi Rawat*
...
### [24] [Envisioning Beyond the Few: Disentangled Semantics and Primitives for Few-Shot Atypical Layout-to-Image Generation](https://arxiv.org/abs/2605.31266)
...
Classification reason: 该论文研究扩散模型中的遗忘学习（unlearning），属于生成模型的概念擦除与遗忘学习范畴。该主题在 multimodal_generation 和 aigc 方向下均有 aigc_unlearning_erasure（概念擦除与遗忘学习）这一现有 subtopic，且为 [CANONICAL] 条目，直接复用。
...
### [30] [TRINE: A Token-Aware, Runtime-Adaptive FPGA Inference Engine for Multimodal AI](https://arxiv.org/abs/2603.22867)
...
### [31] [LVSA: Training-Free Sparse Attention for Long Video Diffusion](https://arxiv.org/abs/2605.31057)
...
### [32] [Zeroth-Order Non-Log-Concave Sampling with Variance Reduction and Applications to Inverse Problems](https://arxiv.org/abs/2605.30573)
...
### [34] [Student Capacity Moderates Knowledge Distillation Effectiveness: A Systematic Study Across ResNet Teacher-Student Pairs on CIFAR-10](https://arxiv.org/abs/2605.31191)
*Umut Onur Yasar*
...
### [36] [Trust-Region Behavior Blending for On-Policy Distillation](https://arxiv.org/abs/2605.31159)
...
### [37] [Calibrated Preference Learning: The Case of Label Ranking](https://arxiv.org/abs/2605.30447)
...
### [38] [Pairwise Reference Alignment as a Model-Level Ordinal Observable](https://arxiv.org/abs/2605.30758)
*Mujing Li*
...
Classification reason: 该论文研究成对偏好参考对齐（pairwise reference alignment）的统计形式化定义，核心是模型评分函数与参考偏好排序之间的一致性度量，属于生成模型对齐与偏好优化的基础理论问题。该工作与 multimodal_generation 和 aigc 方向下的 [CANONICAL] subtopic "generation_alignment（生成模型对齐与奖励）" 高度匹配，故复用该 subtopic。
...
Classification reason: 该论文提出 SAVE 框架，通过价值锚定的在线策略反馈来改进奖励模型（RM）训练，用于语言模型对齐。核心贡献在于奖励建模与偏好优化，属于生成模型对齐与奖励（generation_alignment）这一规范子主题。该子主题在 multimodal_generation 和 aigc 方向下均有收录，因此匹配两个方向。
...
### [40] [Differentially Private Preference Data Synthesis for Large Language Model Alignment](https://arxiv.org/abs/2605.30808)
...
### [41] [Are Full Rollouts Necessary for On-Policy Distillation?](https://arxiv.org/abs/2605.31490)
...
### [42] [Parallel Tempering Initial Sampling in Inference-Time Reward Alignment](https://arxiv.org/abs/2605.30991)
...
Classification reason: 该论文研究推理时奖励对齐（inference-time reward alignment），通过并行回火（parallel tempering）改进扩散/流模型的奖励采样，属于生成模型对齐与奖励优化的核心范畴。multimodal_generation 和 aigc 两个方向下均有该 subtopic，选择 multimodal_generation 作为主方向。
...
### [44] [What Gets Unmasked First? Trajectory Analysis of Diffusion Models for Graph-to-Text Generation](https://arxiv.org/abs/2605.31564)
...
Classification reason: 论文研究掩码扩散语言模型（MDLM）在图到文本生成中的解码轨迹，分析token去掩码顺序并提出lambda缩放结构解码来修正SFT导致的解码策略偏差。这属于生成模型的可控性与解码优化，与multimodal_generation下的[CANONICAL] subtopic "生成模型对齐与奖励"（generation_alignment）中的guidance与可控性方向高度吻合。同时该工作也涉及AIGC领域的文本生成应用。
...
### [46] [Count Anything](https://arxiv.org/abs/2605.30846)
...
Classification reason: 该论文构建了跨域大规模目标计数数据集CLOC（涵盖6个视觉域、约22万张图像、619个类别），并提出通用目标计数模型Count Anything。核心贡献在于统一了分散的计数任务并建立评测基准，因此映射到multimodal_generation下的[CANONICAL] subtopic "生成模型评测与数据集"（generation_benchmark）。同时，该工作也涉及AIGC领域的合成数据与领域应用。
...
### [48] [Conformal Reliability: A New Evaluation Metric for Conditional Generation](https://arxiv.org/abs/2605.30807)
...
Classification reason: 该论文提出了一种基于共形预测的条件生成模型可靠性评估指标（reliability score），属于生成模型评测方法。这与 multimodal_generation 方向下的 [CANONICAL] subtopic "generation_benchmark（生成模型评测与数据集）" 高度匹配，因为该 subtopic 涵盖生成模型评测基准、自动评测指标等。同时该工作也涉及 AIGC 评测。
...
### [49] [3DAE: Binaural Quality Assessment for Audio Novel View Synthesis with Spatial Maps and Benchmark](https://arxiv.org/abs/2605.30469)
*Jialu Xu, Yifan Zhou*
...
Classification reason: 该论文提出3DAE Map（音频误差图）和3DAE Bench（空间音频误差基准），用于评估音频新视角合成（Audio Novel View Synthesis）模型的双耳质量。这属于生成模型（音频生成）的评测基准与诊断框架，因此映射到multimodal_generation下的[CANONICAL] subtopic "generation_benchmark"（生成模型评测与数据集）。同时，该工作也涉及AIGC领域的生成内容质量评估。
...
### [50] [MergeTok: Unified Continuous and Discrete Visual Tokenization via Token Merging](https://arxiv.org/abs/2605.30904)
...
### [51] [Lumos-Nexus: Efficient Frequency Bridging with Homogeneous Latent Space for Video Unified Models](https://arxiv.org/abs/2605.31603)
...
### [52] [Physically Viable World Models: A Case for Query-Conditioned Embodied AI](https://arxiv.org/abs/2605.30542)
...
### [53] [Robust Dreamer: Deviation-Aware Latent Gaussian Memory for Action-Controlled AR Video Generation](https://arxiv.org/abs/2605.30855)
...
### [62] [Latent Space Disentanglement via Activation Steering for Interpretable Attribute Control in Symbolic Music Generation](https://arxiv.org/abs/2605.31295)
...
Classification reason: 该论文专注于从自然语言生成物理示意图（物理领域垂直应用），属于科学/垂直领域内容生成，因此映射到现有 subtopic "领域内容生成应用"（aigc_domain_application），该 subtopic 在 multimodal_generation 和 aigc 方向下均有收录。
...
### [64] [Controllable Lung Nodule Synthesis via Histogram-Regularized Latent Diffusion Models](https://arxiv.org/abs/2605.30631)
...
Classification reason: 该论文聚焦于肺结节合成这一医疗领域应用，属于垂直领域内容生成。multimodal_generation 方向下已有非 canonical 的 aigc_domain_application 子主题（医疗生成应用），且 aigc 方向下也有 canonical 的 aigc_domain_application，两者均可匹配。选择 multimodal_generation 下的 aigc_domain_application 作为主要子主题。
...
Classification reason: 该论文聚焦乳腺钼靶影像报告生成，属于医疗垂直领域的生成应用，与 [CANONICAL] 子主题"领域内容生成应用"（aigc_domain_application）高度匹配。该子主题同时存在于 multimodal_generation 和 aigc 方向下，选择 multimodal_generation 作为主方向更贴合其视觉生成任务本质。
...
Classification reason: 该论文研究手语翻译（SLT），属于垂直领域内容生成应用。手语翻译是跨模态（视频→文本）的生成任务，与"领域内容生成应用"（aigc_domain_application）高度匹配，该 subtopic 在 multimodal_generation 和 aigc 方向下均有收录，因此复用该现有 subtopic。
...
### [67] [A Padding Method for Enhanced Encoding of Inorganic Structures with Varying Chemical Compositions](https://arxiv.org/abs/2605.30743)
...
Classification reason: 该论文聚焦于无机材料生成，属于科学/材料学垂直领域的生成应用，与现有 subtopic "领域内容生成应用"（aigc_domain_application）高度匹配，该 subtopic 在 multimodal_generation 和 aigc 方向下均有收录。
...
### [68] [Rationalize: Shared Semantic Reasoning for Human-AI Alignment](https://arxiv.org/abs/2605.30632)
...
Classification reason: 论文提出 Rationalize 框架，将人机交互建模为互补角色对（Explorer-Guide, Investigator-Informant 等），在共享推理空间中实现人类与 AI（如 LLM）之间的语义对齐。这属于 AI 智能体与人类协作的工作流设计，与 [CANONICAL] aigc_agent_workflow（AI 智能体与生成工作流）高度匹配。
...
### [69] [Extending the UXR Point of View Pyramid: A Generative AI-Augmented Methodology for Human-Centred AI Systems](https://arxiv.org/abs/2605.31143)
...
Classification reason: 该论文提出了一种生成式AI增强的UXR PoV金字塔方法论，将GenAI嵌入用户研究工作流（包括结构化提示架构和AI驱动的Playbook卡片系统），属于AI辅助的生成工作流与自动化创作流水线，因此映射到aigc下的[CANONICAL]子主题"AI智能体与生成工作流"。
...
### [70] [Harness Updating Is Not Harness Benefit: Disentangling Evolution Capabilities in Self-Evolving LLM Agents](https://arxiv.org/abs/2605.30621)
...
Classification reason: 该论文研究LLM智能体的自我进化能力（harness self-evolution），涉及prompt、skills、memories、tools等外部组件的更新与利用，属于LLM智能体与生成工作流范畴，因此映射到aigc下的[CANONICAL] subtopic "AI 智能体与生成工作流"。
...
### [71] [Planner-Centric Reinforcement Learning for Deep Research with Structure-Aware Reward](https://arxiv.org/abs/2605.30824)
...
### [72] [UniScale: Adaptive Unified Inference Scaling via Online Joint Optimization of Model Routing and Test-Time Scaling](https://arxiv.org/abs/2605.30898)
...
Classification reason: 该论文提出UniScale框架，将模型路由（在不同规模模型间切换）与测试时扩展（TTS）统一为在线联合优化问题，建模为上下文多臂老虎机并通过LinUCB学习推理策略。这属于LLM推理工作流的自动化优化，与aigc_agent_workflow（AI智能体与生成工作流）中的自动化创作流水线、工具使用、智能体优化高度相关。
...
### [73] [Crafter: A Multi-Agent Harness for Editable Scientific Figure Generation from Diverse Inputs](https://arxiv.org/abs/2605.30611)
...
Classification reason: 该论文提出从专家知识痕迹自动蒸馏为可移植、可检查、可更新的 AI 技能包（skill package），用于构建人格化 LLM 智能体。核心贡献是端到端的 trace-to-skill 自动化工作流，属于 AI 智能体与生成工作流范畴，因此映射到 canonical 子主题 aigc_agent_workflow。
...
### [75] [AutoSci: A Memory-Centric Agentic System for the Full Scientific Research Lifecycle](https://arxiv.org/abs/2605.31468)
...
Classification reason: 该论文提出 AutoSci，一个基于 LLM 的科研智能体系统，覆盖文献理解、实验、写作、审稿回复等完整科研工作流，属于 AI 智能体与自动化工作流方向，因此映射到 [CANONICAL] aigc_agent_workflow。
...
Classification reason: 该论文提出基于VLM的图像恢复智能体框架DiTTo，使用智能体调度多个恢复专家模型进行多退化图像恢复，属于AI智能体与生成工作流（aigc_agent_workflow）范畴。同时涉及图像生成/恢复，也匹配多模态生成方向。
...
### [77] [Exploring Autonomous Agentic Data Engineering for Model Specialization](https://arxiv.org/abs/2605.30407)
...
### [78] [Counterfactual Graph for Multi-Agent LLM Calibration](https://arxiv.org/abs/2605.30653)
...
Classification reason: 该论文研究多智能体LLM系统的校准问题，属于LLM智能体工作流中的可靠性提升方向，与[AIGC]方向下的[AI智能体与生成工作流]（aigc_agent_workflow）高度匹配。同时涉及多智能体系统的置信度校准，也与多模态理解与生成方向下的智能体工作流相关。
...
### [79] [ElasticMem: Latent Memory as a Learnable Resource for LLM Agents](https://arxiv.org/abs/2605.30690)
...
Classification reason: 该论文研究LLM智能体的长期记忆机制，属于LLM智能体核心能力增强，与AIGC方向下的[AI智能体与生成工作流]规范子主题高度匹配。
...
### [80] [ExpGraph: Model-Agnostic Experience Learning with Graph-Structured Memory for LLM Agents](https://arxiv.org/abs/2605.30712)
...
Classification reason: 该论文提出 ExpGraph，一种模型无关的经验学习框架，使 LLM 智能体能够通过外部经验图（experience graph）复用历史成功策略和失败教训，无需参数更新。核心贡献在于 LLM 智能体的经验复用与工作流优化，属于 AI 智能体与生成工作流（aigc_agent_workflow）这一规范主题。
...
### [81] [An Organization-Scoped LLM Agent Runtime Architecture for Regulated Cybersecurity Operations](https://arxiv.org/abs/2605.30604)
...
### [82] [Skill is Not One-Size-Fits-All: Model-Aware Skill Alignment for LLM Agents](https://arxiv.org/abs/2605.30723)
...
Classification reason: 论文研究LLM智能体的技能对齐与自适应工作流，属于AIGC方向下的AI智能体与生成工作流（aigc_agent_workflow）这一规范子主题。
...
### [83] [Eywa: Provenance-Grounded Long-Term Memory for AI Agents](https://arxiv.org/abs/2605.30771)
*Resham Joshi*
...
Classification reason: 该论文提出 Eywa，一种基于溯源（provenance）的长期记忆架构，用于 AI 智能体的持久化记忆存储、检索、审计与更新。核心贡献在于智能体记忆系统的设计，属于 AI 智能体与工作流范畴，因此映射到 [CANONICAL] aigc_agent_workflow（AI 智能体与生成工作流）。同时涉及多模态理解与生成方向中的智能体应用。
...
### [84] [Extending AI for Research to the Humanities: A Multi-Agent Framework for Evidence-Grounded Scholarship](https://arxiv.org/abs/2605.30947)
...
### [85] [Design and Evaluation of Multi-Agent AI Oracle Systems for Prediction Market Resolution](https://arxiv.org/abs/2605.30802)
*Tarun Kota*
...
Classification reason: 论文研究多智能体LLM架构用于预测市场结果裁决，属于LLM智能体与自动化工作流范畴，与[AIGC]方向下的"AI 智能体与生成工作流"（aigc_agent_workflow）高度匹配。
...
Classification reason: 该论文研究训练数据集的成员推断（membership inference），即通过模型内部语义相关性结构识别某个数据集是否被用于训练。这属于AIGC检测与溯源（aigc_detection_attribution）范畴，因为其核心是溯源与归因——判断数据集的来源与使用情况，与深伪检测、生成模型溯源同属检测与归因方向。

Importance reason: Focuses on dataset membership inference for AIGC detection, which is not a priority subtopic and lacks direct connection to generation or efficiency. Signals: Dataset membership inference, Semantic correlation descriptors, AIGC detection, White-box fingerprinting, Low personal relevance
...
### [87] [BIAS-ID: A Framework for Analyzing Transformation Biases in AI-Generated Image Detectors](https://arxiv.org/abs/2605.31153)
...
Classification reason: 论文研究 AI 生成图像检测器中的变换偏差分析与量化框架，属于 AIGC 检测方向，与 [CANONICAL] 子主题 "AIGC 检测与溯源" 高度匹配。
...
### [88] [The Regularizing Power of Language-Training Deepfake Detectors](https://arxiv.org/abs/2605.31192)
...
Classification reason: 论文研究深度伪造检测（deepfake detection），属于 AIGC 检测与溯源这一 [CANONICAL] 子主题的核心范畴。
...
Classification reason: 该论文研究 Copy Detection Patterns (CDP) 的认证方法，属于物理对象上的防伪检测与溯源技术，与 AIGC 检测与溯源（aigc_detection_attribution）方向高度相关，因此复用该规范子主题。

Importance reason: Focuses on niche AIGC detection for physical copy patterns, not aligned with priority generative model topics. Signals: AIGC detection, cross-camera authentication, copy detection patterns, not autoregressive/diffusion generation, no world model or efficient inference
...
### [90] [TSM-Bench: Detecting LLM-Generated Text in Real-World Wikipedia Editing Practices](https://arxiv.org/abs/2605.31113)
...
Classification reason: 该论文研究 LLM 生成文本检测（MGT detection），属于 AIGC 检测与溯源方向，与 canonical subtopic "aigc_detection_attribution" 完全匹配。
...
### [91] [How Early Adopters Used Generative AI Worldwide: Variation by Country Income and Language](https://arxiv.org/abs/2605.30685)
...
Classification reason: 该论文研究全球不同收入水平和语言背景下用户对生成式AI聊天机器人的使用模式差异，属于对AIGC实际使用情况的实证分析与评测，与[AIGC 评测与基准]方向高度相关（评测AIGC的实际使用分布与数字鸿沟影响）。

Importance reason: Focuses on AIGC usage patterns and digital divide, not on core technical advances in generation models. Signals: AIGC usage analysis, country-level variation, language performance gap, not technical model improvement
...
### [92] [Translation Analytics for Freelancers II: Benchmarking Local LLMs for Confidential Translation Workflows](https://arxiv.org/abs/2605.31452)
...
Classification reason: 该论文对本地可运行的 LLM 在保密翻译场景下的翻译质量进行系统评测和基准测试，属于 AIGC 方向下的生成内容质量评测与基准（aigc_evaluation_benchmark），该 [CANONICAL] 子主题涵盖翻译质量评估等生成内容评测任务。
...
### [93] [EHRBench: An Automated and Reliable EHR-based Benchmark for Clinical Decision Making with LLMs](https://arxiv.org/abs/2605.30637)
...
Classification reason: 该论文构建了基于真实EHR的临床决策LLM评测基准EHRBench，属于AIGC评测与基准（aigc_evaluation_benchmark）范畴，同时涉及多模态理解与生成方向中的多模态评测与基准（multimodal_benchmark），但核心更偏向AIGC领域的生成式模型评测。
...
### [94] [A Persona-Based Evaluation Framework for Pluralistic Alignment in Generative AI](https://arxiv.org/abs/2605.31021)
*Atahan Karagoz*
...
Classification reason: 该论文提出基于人格（persona）的生成式AI对齐评估框架，属于AIGC评测范畴，与[CANONICAL] subtopic "AIGC 评测与基准"（aigc_evaluation_benchmark）高度匹配。同时涉及生成模型对齐（generation_alignment）和多模态对齐评估（multimodal_rl_alignment），因此也匹配另外两个方向。
...
### [95] [LLM-FACETS: A Privacy-Preserving Framework for Evaluating LLM Transparency and Accountability](https://arxiv.org/abs/2605.31167)
...
Classification reason: 该论文提出 LLM-FACETS，一个用于评估 LLM 输出事实性、校准性和可复现性的开源框架，属于 AIGC 方向下的生成内容质量评测范畴，与 canonical 子主题 aigc_evaluation_benchmark（AIGC 评测与基准）高度匹配。
...
### [96] [Industrializing Prediction-Powered Inference: The GLIDE Library for Reliable GenAI and Agentic Systems Evaluation](https://arxiv.org/abs/2605.31278)
...
Conclusion: GLIDE 为生成式 AI 和智能体系统的可靠评估提供了统一、易用的工具，有望推动 PPI 方法在 AIGC 评估中的广泛采用。

Classification reason: 该论文关注智能体系统的可靠评估方法，提出基于预测驱动推断（PPI）的统一评估库 GLIDE，属于 AIGC 评测与基准方向。论文核心是解决 LLM-as-judge 评估偏差问题，与 [CANONICAL] aigc_evaluation_benchmark（AIGC 评测与基准）高度匹配。
...
### [97] [TraceGraph: Shared Decision Landscapes for Diagnosing and Improving Agent Trajectories](https://arxiv.org/abs/2605.31308)
...
Classification reason: 该论文提出 TraceGraph 框架，将多模型智能体轨迹转化为共享决策景观图，用于诊断和改善智能体行为，核心贡献在于智能体评测方法创新（揭示聚合分数隐藏的导航差异、识别陷阱区域等），属于 AIGC 评测与基准方向，因此映射到 canonical 子主题 aigc_evaluation_benchmark。
...
### [98] [Protocol for evaluating ChatGPT in biomedical association generation and verification using a RAG-enabled, cross-model majority voting workflow](https://arxiv.org/abs/2605.30400)
...
Classification reason: 该论文提出评估ChatGPT生成生物医学关联能力的协议，涉及生成内容可靠性评测与幻觉检测，属于AIGC评测范畴，因此映射到[CANONICAL] subtopic "AIGC 评测与基准"。
...
### [99] [Auditing LLM Benchmarks with Item Response Theory](https://arxiv.org/abs/2605.30504)
...
Classification reason: 该论文研究 LLM 基准测试中的标签错误审计问题，属于 AIGC 评测与基准方向。论文使用项目反应理论（IRT）检测偏好基准和多选题基准中的错误标签，与 [CANONICAL] subtopic "AIGC 评测与基准"（aigc_evaluation_benchmark）高度匹配。
...
### [100] [LongDS-Bench: On the Failure of Long-Horizon Agentic Data Analysis](https://arxiv.org/abs/2605.30434)
...
Classification reason: 该论文提出了一个面向长程、多轮数据分析的基准 LongDS-Bench，属于 AIGC 评测与基准（aigc_evaluation_benchmark）范畴，评测智能体在长程数据分析中的状态追踪与演化能力。

Importance reason: High-quality benchmark exposing a critical bottleneck in long-horizon agentic data analysis, directly relevant to AIGC evaluation and model efficiency. Signals: Long-horizon agent benchmark, state-evolution patterns, 52%-69% long-horizon errors, performance drop 47 points, best model 48.45% accuracy
...
Classification reason: 该论文研究黑盒LLM蒸馏的行为不可区分性评估，提出有界行为不可区分性形式化框架，属于AIGC评测范畴（评估蒸馏模型与教师模型的行为相似度而非仅输出相似度），因此映射到[AIGC]方向下的[CANONICAL] subtopic "AIGC 评测与基准"。
...
Classification reason: 该论文提出了一个评估LLM代码生成能力的基准（CodeGolf Bench），属于AIGC领域中的生成内容评测与基准方向，与[CANONICAL] subtopic "AIGC 评测与基准"（aigc_evaluation_benchmark）高度匹配。
...
Classification reason: 该论文提出因果敏感性分数（CSS）作为临床LLM和智能体的干预式评测指标，属于AIGC评测与基准范畴，与[CANONICAL] subtopic aigc_evaluation_benchmark高度匹配。
...
### [104] [Cognitive Fatigue in Autoregressive Transformers: Formalization and Measurement](https://arxiv.org/abs/2605.30981)
...
Classification reason: 该论文形式化并测量自回归语言模型在长序列生成中的退化现象（疲劳），提出了一个运行时诊断指标 Fatigue Index (FI)，属于生成模型的质量评测与可靠性监控范畴，与 [CANONICAL] subtopic "AIGC 评测与基准" 高度匹配。

Importance reason: Novel formalization of LLM degradation with practical diagnostic, but only tangentially touches user's priority subtopics. Signals: autoregressive, efficient inference, model efficiency, AIGC 评测与基准, non-monotonic scaling
...
### [105] [KnowledgeGain: Evaluating and Optimizing Science News Generation for Reader Learning](https://arxiv.org/abs/2605.31099)
...
Classification reason: 该论文提出 KnowledgeGain 指标，用于评估科学新闻生成文本的知识增益质量，属于 AIGC 生成内容质量评测范畴，与 [CANONICAL] 子主题 "AIGC 评测与基准" 高度匹配。

Importance reason: Focuses on science news evaluation metric, not directly on core generative model advances. Signals: AIGC evaluation, knowledge gain metric, LLM reader simulator, not autoregressive/diffusion generation, no video/image generation
...
### [106] [OpenSTBench: Beyond Semantic Evaluation for Speech Translation](https://arxiv.org/abs/2605.30792)
...
Classification reason: 该论文提出语音翻译系统的统一多维评估框架 OpenSTBench，属于 AIGC 评测与基准（aigc_evaluation_benchmark）这一规范主题，因为其核心贡献是构建评测协议和基准来评估生成内容（翻译语音/文本）的质量。
...
### [107] [Welfare, Improvability, and Variance: A Principal-Agent Approach to Optimal Benchmark Item Aggregation](https://arxiv.org/abs/2605.30916)
...
Classification reason: 该论文研究AI基准测试中项目聚合的最优方法，属于AIGC评测与基准（aigc_evaluation_benchmark）这一规范主题。论文将基准测试建模为多任务主从博弈，提出基于福利、可改进性和方差三个维度的审计框架来优化基准聚合方式，直接对应AIGC评测方法论。
...
### [108] [BlueFin: Benchmarking LLM Agents on Financial Spreadsheets](https://arxiv.org/abs/2605.30907)
...
Classification reason: 该论文提出了一个面向金融电子表格的 LLM 智能体评测基准 BlueFin，属于 AIGC 评测与基准（aigc_evaluation_benchmark）范畴，同时也涉及多模态理解与生成方向中的多模态评测与基准（multimodal_benchmark），但核心更偏向 AIGC 领域的评测基准。
...
Classification reason: 该论文研究个性化对齐评估方法，提出从用户历史交互中学习评估准则（rubric）的框架 PARL，属于生成内容质量评测与人类偏好对齐评估范畴，与 AIGC 方向下的 [CANONICAL] 子主题 "AIGC 评测与基准" 高度匹配。同时涉及个性化对齐，也与多模态理解与生成方向相关。
...
### [110] [Personalized to Persuade: The Effects of Contextualization and Warmth on Trust and Reliance in Conversational AI](https://arxiv.org/abs/2605.31275)
...
Classification reason: 该论文研究对话式AI中个性化（contextualization）与温暖感（warmth）对用户信任和依赖的影响，属于AIGC方向下的个性化与对话生成（aigc_personalization_persona）范畴，该子主题涵盖个性化助手、对话生成与角色扮演等主题，与本论文高度匹配。
...
### [111] [SteerFace: Debiasing Synthetic Face Generation via Adaptive Residue Perturbation](https://arxiv.org/abs/2605.30894)
...
Classification reason: 该论文研究利用扩散模型生成合成人脸数据用于人脸识别训练，属于合成训练数据生成范畴，与现有 canonical subtopic "合成数据与数据集蒸馏"（aigc_synthetic_data）高度匹配。
...
### [112] [Iterative Framework For Data Augmentation Of Segmented Fingerprints](https://arxiv.org/abs/2605.31001)
...
Classification reason: 该论文提出了一种迭代式数据增强方法，通过诱导CNN错误来生成多样化的指纹分割变体，属于合成训练数据生成与数据增强范畴，与现有规范子主题"合成数据与数据集蒸馏"(aigc_synthetic_data)高度匹配。
...
### [113] [Not All Synthetic Data Is Yours to Learn From](https://arxiv.org/abs/2605.31126)
...
Classification reason: 论文研究语言模型使用自身合成文本进行自训练的效果与条件，核心是合成数据的效用问题，属于 AIGC 方向下的"合成数据与数据集蒸馏"（aigc_synthetic_data）这一规范子主题。同时，该工作也涉及生成模型（语言模型）的自生成数据训练，与多模态生成方向下的合成数据子主题相关。
...
Classification reason: 该论文研究机器遗忘（machine unlearning），提出面向因果知识的遗忘方法 MAAT 和评测基准 5WBENCH，属于 AIGC 方向下的「概念擦除与遗忘学习」规范子主题。
...
Classification reason: 该论文研究医学大语言模型的机器遗忘（machine unlearning），属于生成模型概念擦除与遗忘学习范畴。现有 [CANONICAL] subtopic "aigc_unlearning_erasure" 完全匹配，且该论文也涉及多模态理解与生成方向（医学LLM）。
...
Classification reason: 该论文提出推理时遗忘（unlearning）方法，使用辅助模型在推理阶段引导LLM远离特定数据，属于生成模型的概念擦除与遗忘学习。该主题在aigc方向下有[CANONICAL] subtopic "概念擦除与遗忘学习"（aigc_unlearning_erasure），完美匹配。同时论文也探索了在图像领域的泛化，因此也匹配multimodal_generation方向。
...
Classification reason: 该论文研究 LLM 遗忘学习（unlearning），属于生成模型安全与治理范畴。aigc 方向下已有 [CANONICAL] 子主题 "概念擦除与遗忘学习"（aigc_unlearning_erasure），该论文提出的基于数据归因奖励的遗忘框架完全匹配该子主题定义。同时 multimodal_understanding_generation 方向下也有同名子主题，但论文主要聚焦 LLM 而非多模态模型，故以 aigc 为主方向。
...
Classification reason: 该论文研究机器遗忘（machine unlearning）中的局部连带遗忘现象，属于模型 unlearning 范畴。aigc 方向下已有 [CANONICAL] 子主题 "概念擦除与遗忘学习"（aigc_unlearning_erasure），与该论文主题高度匹配，因此直接复用。
...
### [119] [Anchoring LLM Gender Bias to Human Baselines: A Cross-Lingual Audit](https://arxiv.org/abs/2605.30804)
...
Classification reason: 该论文审计LLM中的性别刻板印象偏见，属于生成模型的公平性与偏见问题，与AIGC方向下的[CANONICAL] subtopic "模型鲁棒性与隐私"（aigc_robustness_privacy）中的公平性（fairness, bias）关键词高度匹配。
...
### [120] [Linear Ensembles Wash Away Watermarks: On the Fragility of Distributional Perturbations in LLMs](https://arxiv.org/abs/2605.30501)
...
Classification reason: 该论文研究LLM生成文本的水印脆弱性，属于AIGC方向下的水印与版权保护（aigc_watermark_copyright）这一规范子主题，直接对应水印的安全性与鲁棒性分析。
...
### [121] [EUDAIMONIA: Evaluating Undesirable Dynamics in AI](https://arxiv.org/abs/2605.30654)
...
Classification reason: 该论文研究LLM作为社交伴侣时产生的有害社交动态（有害亲密、依赖、过度参与），属于AIGC安全与治理范畴，映射到[CANONICAL] subtopic aigc_safety_governance（生成内容安全与治理）。同时涉及多模态理解与生成方向中的安全对齐问题。
...
Classification reason: 论文关注 LLM 搜索智能体的安全对齐问题，属于 AIGC 方向下的生成内容安全与治理（aigc_safety_governance）范畴，同时涉及多步推理与工具使用，也与多模态理解与生成方向下的智能体工作流（aigc_agent_workflow）相关。
...
### [123] [Mental Damage: Caption Poisoning Attacks on Retrieval-Augmented Text-to-Music Generation](https://arxiv.org/abs/2605.30365)
...
Conclusion: 检索增强文生音乐系统存在数据库投毒的安全隐患，攻击者可通过少量恶意字幕操控生成内容。该工作揭示了AIGC系统中检索增强组件的安全脆弱性，为后续防御研究提供了基础。

Classification reason: 该论文研究针对检索增强文生音乐系统的数据库投毒攻击，属于AIGC安全与治理范畴，与现有[CANONICAL]子主题"生成内容安全与治理"(aigc_safety_governance)高度匹配。
...
### [124] [Configurable Reward Model for Balanced Safety Alignment](https://arxiv.org/abs/2605.30487)
...
Classification reason: 论文提出可配置的安全奖励模型（CSRM）用于LLM安全对齐，属于生成内容安全与治理范畴，与AIGC方向下的aigc_safety_governance（生成内容安全与治理）高度匹配。同时涉及多模态理解与生成方向下的generation_alignment（生成模型对齐与奖励），但核心贡献在安全治理。
...
Classification reason: 该论文研究大模型在公开数值基准上的记忆泄露问题（NumLeak），属于生成模型的安全与治理范畴。论文揭示了模型在预训练中记忆了公开数值数据（如Fama-French因子、经济指标），导致评测结果不可靠，并提出防御方法。这与aigc_safety_governance（生成内容安全与治理）高度相关，涉及模型安全、数据泄露、评测可靠性等治理议题。
...
### [126] [The Architecture of Errors: From Universal Impossibility to Patch-Local LLM Reliability](https://arxiv.org/abs/2605.30628)
...
Classification reason: 该论文从理论层面论证了通用 LLM 可靠性在无限域上的不可能性，并提出在操作有界补丁（如法律审查、医疗 RAG、代码修复等）内通过局部故障目录发现与干预覆盖实现可靠性的框架。这属于 AIGC 安全与治理范畴，与现有 canonical 子主题「生成内容安全与治理」高度相关。
...
### [127] [MosaicLeaks:Privacy Risks in Querying-in-the-Open for Deep Research Agents](https://arxiv.org/abs/2605.30727)
...
Classification reason: 该论文研究深度研究智能体在查询外部工具时泄露私有信息的隐私风险，属于AIGC安全与治理范畴。论文提出的MosaicLeaks基准评估了智能体查询中的信息泄露，并提出了隐私感知的RL训练框架PA-DR来缓解泄露，与aigc_safety_governance（生成内容安全与治理）中的安全、合规、监管主题高度吻合。
...
### [128] [Latent Geometric Chords for Query-Efficient Decision-Based Adversarial Attacks](https://arxiv.org/abs/2605.31219)
...
Classification reason: 该论文研究黑盒对抗攻击（adversarial attacks），属于AI安全范畴。在AIGC方向下，[CANONICAL] subtopic "生成内容安全与治理"（aigc_safety_governance）涵盖内容审核、有害内容检测等安全主题，对抗攻击是安全治理的重要组成部分，因此映射至此。
...
### [129] [Steering LLMs? Actually, Sparse Autoencoders can outperform simple baselines](https://arxiv.org/abs/2605.31183)
...
Classification reason: 该论文研究通过稀疏自编码器（SAE）对LLM进行模型输出引导（steering），属于生成内容安全与治理中模型行为控制与安全生成范畴。虽然aigc_unlearning_erasure（概念擦除与遗忘学习）也相关，但本文核心是steering（引导）而非擦除，且aigc_safety_governance涵盖更广泛的模型行为控制与安全生成，故归入此类。
...
### [130] [AdvScene: Rethinking Adversarial Patch Evaluation Through Scene Robustness](https://arxiv.org/abs/2605.30578)
*Xiaoyong, Yuan, Zhang*
...
Classification reason: 该论文研究对抗性补丁（adversarial patches）在真实场景下的鲁棒性评估，属于AI安全与对抗攻击防御范畴，与AIGC方向下的"生成内容安全与治理"（aigc_safety_governance）主题高度相关，该主题涵盖有害内容检测与安全评测。
...
### [131] [EvoDefense: Co-Evolving Black-Box Defense with Large Language Models](https://arxiv.org/abs/2605.31140)
...
Classification reason: 该论文提出针对LLM黑盒攻击的防御方法，属于生成内容安全与治理范畴，与AIGC方向下的[CANONICAL] subtopic "生成内容安全与治理"（aigc_safety_governance）高度匹配。同时涉及多模态理解与生成方向下的多模态安全与攻防（multimodal_safety_attack），但核心贡献更偏向AIGC安全防御。
...
### [132] [Send a SCOUT First: Pre-hoc Reasoning for Adaptive Detector Allocation in Prompt-Injection Defense](https://arxiv.org/abs/2605.30837)
...
Classification reason: 该论文研究提示注入攻击的防御方法，属于AIGC安全治理范畴。论文提出的SCOUT框架通过动态分配检测器来防御提示注入攻击，与aigc_safety_governance（生成内容安全与治理）中的内容审核、有害内容检测高度匹配。
...
### [133] [Federated Variational Preference Alignment with Gumbel-Softmax Prior for Personalized User Preferences](https://arxiv.org/abs/2605.30873)
...
### [134] [Sound effects in media:A comparative analysis of recorded and synthetic samples in live-action and animation](https://arxiv.org/abs/2605.31082)
...
Classification reason: 该论文研究程序化音频（数字拟音）在媒体制作中的应用，比较合成音效与真实录音在动画和实拍场景中的可信度，属于AIGC方向下的视频音频生成应用（aigc_video_audio_creation）范畴，该子主题涵盖音视频编辑与内容创作产品级生成应用。
...
### [135] [AnchorSteer: Self-Discovered Concept Injection for Structure-Preserving Music Editing](https://arxiv.org/abs/2605.31053)
...
Classification reason: 论文研究可控音乐编辑（音频编辑），属于AIGC方向下的"视频音频生成应用"（aigc_video_audio_creation）范畴，该子主题涵盖音视频编辑与内容创作应用。同时与多模态生成方向下的"音频与多模态联合生成"（audio_av_generation）也相关。
...
### [136] [A Pilot Study on Curator-Guided Multilingual Art Description for Blind and Low-Vision Audiences with Small Vision-Language Models](https://arxiv.org/abs/2605.31080)
...
Classification reason: 该论文研究面向盲人和低视力（BLV）观众的多语言艺术描述生成，属于垂直领域（博物馆/艺术）的内容生成应用，与 aigc_domain_application（领域内容生成应用）高度匹配。同时涉及小规模视觉语言模型（VLM）的应用，也与多模态理解与生成方向相关。
...
### [137] [UXR PoV for Neuroinclusive Emotion Regulation](https://arxiv.org/abs/2605.31131)
...
Classification reason: 该论文将生成式AI应用于ADHD情绪调节的数字心理健康设计，属于医疗健康垂直领域的生成应用，与现有 canonical subtopic "领域内容生成应用"（aigc_domain_application）高度匹配。
...
### [138] [On-Device Generative AI for GDPR-Compliant Visual Monitoring: Natural Language Alerts from Local Object Detection](https://arxiv.org/abs/2605.30544)
...
Classification reason: 该论文使用大语言模型生成合成数据，构建面向临床ICD编码检索的医疗领域检索器，属于医疗垂直领域的生成应用，因此映射到aigc下的[CANONICAL] subtopic "领域内容生成应用"（aigc_domain_application）。
...
Classification reason: 该论文研究临床LLM在语义等价改写下的稳定性与鲁棒性，属于医疗垂直领域的LLM应用评估，与现有规范子主题"领域内容生成应用"（aigc_domain_application）高度匹配。
...
Classification reason: 该论文聚焦于CT影像报告自动生成，属于医疗垂直领域的生成应用，与现有 canonical subtopic "aigc_domain_application（领域内容生成应用）" 高度匹配。
...
Classification reason: 该论文聚焦深度学习模型在疟疾诊断（医疗领域）中的应用评估，属于垂直领域内容生成应用范畴，因此映射到 [CANONICAL] 的 aigc_domain_application（领域内容生成应用）。
...
### [144] [Enhancing Computer Vision Model Generalization in Warehouse Facilities: A Case Study on Anomaly Detection in Vertical Material Handling Systems](https://arxiv.org/abs/2605.31487)
...
Classification reason: 该论文研究仓库设施中垂直物料搬运系统的异常检测视觉模型泛化问题，属于工业/仓储领域的计算机视觉应用，与"领域内容生成应用"（aigc_domain_application）方向匹配，该子主题涵盖垂直领域应用。
...
### [145] [Learning Whom to Trust: Market-Feedback Adaptive Retrieval for Frozen LLMs in Event-Driven Financial RAG](https://arxiv.org/abs/2605.31201)
...
Classification reason: 该论文研究金融领域的检索增强生成（RAG）系统，属于垂直领域（金融）的生成应用，因此映射到 [CANONICAL] 的 aigc_domain_application（领域内容生成应用）。同时论文涉及多模态理解与生成方向中的检索增强生成，因此也匹配 multimodal_understanding_generation 方向。
...
### [146] [Reliable Multilingual Orthopedic Decision Support from Clinical Narratives: Language-Aware Adaptation and Verification-Guided Deferral](https://arxiv.org/abs/2605.31512)
...
Classification reason: 该论文聚焦于多语言骨科临床决策支持，属于医疗垂直领域的文本分类与决策辅助应用，与 [CANONICAL] 子主题"领域内容生成应用"（aigc_domain_application）高度匹配。
...
### [147] [Improving Small Language Models for Code Generation with Reinforcement Learning from Verification Feedback](https://arxiv.org/abs/2605.30478)
...
Classification reason: 该论文研究使用强化学习（RLVR）改进小语言模型的代码生成能力，属于代码生成这一垂直领域应用。现有 taxonomy 中 aigc_domain_application（领域内容生成应用）明确包含代码生成，且该 subtopic 在 aigc 和 multimodal_generation 方向下均有收录，因此复用该 subtopic。
...
Classification reason: 该论文聚焦电力系统代码生成，属于垂直领域（代码/科学工程）的生成应用，与 [CANONICAL] 的 aigc_domain_application（领域内容生成应用）高度匹配。
...
Classification reason: 该论文提出基于MLLM的Web智能体SCALE，通过自认知探索与环境交互实现自主学习和自适应，属于LLM智能体与自动化工作流范畴。映射到multimodal_understanding_generation方向下的[CANONICAL] subtopic "aigc_agent_workflow"（AI智能体与生成工作流），同时该方向也匹配aigc方向。
...
Classification reason: 该论文研究 GUI 智能体通过强化学习进行粗到细的 GUI 元素定位，属于多模态理解与生成方向下的 AI 智能体与生成工作流（aigc_agent_workflow）范畴，涉及智能体决策、工具增强和自动化交互流程。
...
Classification reason: 该论文研究多模态智能体的长期记忆生成策略，属于多模态智能体（multimodal agent）的核心能力构建，与 aigc_agent_workflow（AI 智能体与生成工作流）高度匹配。同时涉及多模态理解与生成方向中的 MLLM 基础模型（Qwen3-VL）应用。
...
Classification reason: 该论文提出 DetAS，一个基于 MLLM 作为中央智能体的目标检测框架，通过动态组合恢复模块和专用检测器来构建检测工作流，属于 LLM 智能体与自动化工作流范畴，因此映射到 [CANONICAL] 的 aigc_agent_workflow（AI 智能体与生成工作流）。同时涉及 MLLM 作为核心组件，也匹配 multimodal_understanding_generation 方向。
...
### [154] [Vision-Language Models Suppress Female Representations Under Ambiguous Input](https://arxiv.org/abs/2605.31556)
...
### [155] [Seeing Isn't Knowing: Do VLMs Know When Not to Answer Spatial Questions (and Why)?](https://arxiv.org/abs/2605.30557)
...
### [162] [Fighting Numerical Hallucinations via Data-centric Compilation for Online Financial QA](https://arxiv.org/abs/2605.31064)
...
Classification reason: 该论文聚焦金融QA场景中的数值推理幻觉问题，属于多模态幻觉与可靠性（multimodal_hallucination）这一[CANONICAL]子主题。同时涉及AIGC领域内容生成应用（金融领域QA生成）。
...
### [163] [Attend to Evidence: Evidence-Anchored Spatial Attention Supervision for Multimodal RLVR](https://arxiv.org/abs/2605.30912)
...
### [164] [Diversity Matters: Revisiting Test-Time Compute in Vision-Language Models](https://arxiv.org/abs/2605.30713)
...
### [165] [ReGuLaR: Relation-Grounded Latent Reasoning for Large Vision-Language Models](https://arxiv.org/abs/2605.30587)
...
### [166] [iVGR: Internalizing Visually Grounded Reasoning for MLLMs with Reinforcement Learning](https://arxiv.org/abs/2605.31096)
...
### [168] [LARK: Learnability-Grounded Trajectory Selection for Efficient Reasoning Distillation](https://arxiv.org/abs/2605.30651)
...
### [169] [The Sword, Shield, and Achilles' Heel: Characterizing the Linguistic Inductive Bias of Large Language Models for Spatial Reasoning in Navigation Planning](https://arxiv.org/abs/2605.31404)
...
### [170] [LongTraceRL: Learning Long-Context Reasoning from Search Agent Trajectories with Rubric Rewards](https://arxiv.org/abs/2605.31584)
...
### [171] [Variational Adapter for Cross-modal Similarity Representation](https://arxiv.org/abs/2605.30968)
...
### [172] [DisasterLex: An Expert Concept-to-Schema Knowledge Graph for Geospatial Reasoning in Disaster Analytics](https://arxiv.org/abs/2605.30538)
...
### [173] [Beyond Classification: Dynamic Adapter Routing for Continual Multimodal Retrieval](https://arxiv.org/abs/2605.31229)
...
### [174] [Inference-Free Multimodal Learned Sparse Retrieval for Production-Scale Visual Document Search](https://arxiv.org/abs/2605.30917)
...
Classification reason: 该论文提出了FBHM，一个针对仇恨模因检测的功能性基准，属于多模态评测与基准（multimodal_benchmark）这一[CANONICAL]子主题。同时涉及AIGC方向的安全治理（aigc_safety_governance）相关内容，但核心贡献是评测基准。
...
### [177] [PInVerify: An Offline Embodied Benchmark for Active Instance Verification](https://arxiv.org/abs/2605.30639)
*Yuhang Jiang*
...
### [178] [FAM-Bench: A Multimodal Benchmark for Condition-Aware Food-as-Medicine Reasoning](https://arxiv.org/abs/2605.31410)
...
Classification reason: 该论文提出了一个多模态食品即药物（Food-as-Medicine）推理基准 FAM-Bench，包含2500个专家验证实例，评估模型在饮食相关健康条件下的推理能力。这属于多模态评测与基准（multimodal_benchmark）这一[CANONICAL]子主题，因为论文核心贡献是构建了一个新的多模态评测基准。同时该基准涉及AI生成内容在健康领域的应用评估，也匹配AIGC方向下的领域内容生成应用（aigc_domain_application），但主要贡献是评测基准，因此主方向为多模态理解与生成。
...
### [179] [Does Visual Information Play a Decisive Role in Vision-Language-Action Model Driving Behavior?](https://arxiv.org/abs/2605.31041)
...
### [180] [TeachObs: A Human-Validated Benchmark for Multimodal Teaching Observation and Model Evaluation](https://arxiv.org/abs/2605.30673)
...
Classification reason: 该论文提出了一个针对课堂教学视频的多模态观察基准 TeachObs，包含人工标注的视觉/非视觉教学行为编码和课程级评分，并评估了多个视觉语言模型。这属于多模态评测与基准（multimodal_benchmark）这一规范主题，同时与 AIGC 评测（aigc_evaluation_benchmark）也有一定关联。
...
### [181] [Probing Collision Grounding in Vision-Language Models for Safe Human-Robot Collaboration](https://arxiv.org/abs/2605.31196)
...
### [183] [MineExplorer: Evaluating Open-World Exploration of MLLM Agents in Minecraft](https://arxiv.org/abs/2605.30931)
...
Classification reason: 该论文提出了 MineExplorer 基准，用于评估 MLLM 智能体在 Minecraft 开放世界中的探索能力，属于多模态智能体评测。这与 [CANONICAL] 多模态评测与基准 (multimodal_benchmark) 高度匹配，因为论文核心贡献是一个新的评测基准。同时，论文使用了多智能体合成工作流来构建评测实例，也与 aigc 方向下的 AI 智能体与生成工作流 (aigc_agent_workflow) 相关。
...
### [184] [Beyond Static Dialogues: Benchmarking Realistic, Heterogeneous, and Evolving Long-Term Memory](https://arxiv.org/abs/2605.31086)
...
### [185] [SVI-Bench: A Dynamic Microworld for Strategic Video Intelligence](https://arxiv.org/abs/2605.31529)
...
### [187] [EGOSTREAM: A Diagnostic Benchmark for Streaming Episodic Memory in Egocentric Vision](https://arxiv.org/abs/2605.31557)
...
### [188] [nuReasoning: A Reasoning-Centric Dataset and Benchmark for Long-Tail Autonomous Driving](https://arxiv.org/abs/2605.31572)
...
### [189] [Recognizing Co-Speech Gestures in-the-Wild](https://arxiv.org/abs/2605.31589)
...
### [190] [SOCO: Benchmarking Semantic Object Correspondence in Vision Foundation Models](https://arxiv.org/abs/2605.31597)
...
### [191] [A Visually Impaired Assistance Benchmark for VLM-as-a-Judge Evaluation](https://arxiv.org/abs/2605.31351)
...
Classification reason: 该论文提出了 VIABLE，首个面向视障辅助（VIA）场景的 VLM-as-a-Judge 评测基准，属于多模态评测与基准方向。同时涉及 AIGC 评测（aigc_evaluation_benchmark）中的生成内容质量评估与人类偏好对齐评估。最佳匹配为 multimodal_understanding_generation 下的 [CANONICAL] subtopic "多模态评测与基准"（multimodal_benchmark）。
...
### [192] [PEEK: Picking Essential frames via Efficient Knowledge distillation](https://arxiv.org/abs/2605.31029)
...
### [193] [VisionPulse: Dynamic Visual Sparsity for Efficient Multimodal Reasoning](https://arxiv.org/abs/2605.31457)
...
### [194] [Linear Scaling Video VLMs for Long Video Understanding](https://arxiv.org/abs/2605.31598)
...
### [195] [VLM3: Vision Language Models Are Native 3D Learners](https://arxiv.org/abs/2605.30561)
...
### [196] [SpatialAct: Probing Spatial Reasoning-to-Action Capabilities of VLM Agents in 3D Scenes](https://arxiv.org/abs/2605.31148)
...
### [197] [Multi-Turn Multi-Agent Dialogue for Collaborative Reconstruction Improves VLM Performance on Spatial Reasoning, But Only Barely](https://arxiv.org/abs/2605.31387)
...
### [198] [VLM-GLoc: Vision-Language Model Enhanced Monte Carlo Localization for Robust Semantic Global Localization in Cluttered Quasi-Static Environments](https://arxiv.org/abs/2605.30506)
...
### [199] [Representation Forcing for Bottleneck-Free Unified Multimodal Models](https://arxiv.org/abs/2605.31604)
...
### [201] [DriveMA: Driving Vision-Language-Action Models with verifiable Meta-Actions](https://arxiv.org/abs/2605.31271)
...
### [202] [How can embedding models bind concepts?](https://arxiv.org/abs/2605.31503)
...
### [203] [Personalize Your Large Vision-language Models With In-context Prompt Tuning](https://arxiv.org/abs/2605.31513)
...
### [205] [Seeing Before Agreeing: Aligning Multi-Agent Consensus with Visual Evidence](https://arxiv.org/abs/2605.30698)
...
### [206] [MechVQA: Benchmarking and Enhancing Multimodal LLMs on Comprehensive Mechanical Drawing Understanding](https://arxiv.org/abs/2605.30794)
...
### [208] [SLAP: The Semantic Least Action Principle for Variational Video-Language Modeling](https://arxiv.org/abs/2605.30750)
...
### [209] [Towards Effective Long-Video Event Prediction via Multi-Level Event Semantics Mining](https://arxiv.org/abs/2605.31069)
...
### [210] [HiERO-StepG @ Ego4D Step Grounding Challenge: hierarchical activity understanding enables zero-shot step grounding](https://arxiv.org/abs/2605.31227)
...
### [211] [Simple Token-Efficient Vision-Language Model for Case-level Pathology Synoptic Report Generation](https://arxiv.org/abs/2605.30716)
...
Classification reason: 该论文聚焦病理学全切片图像（WSI）的结构化报告生成，属于医疗垂直领域的生成应用，与现有 canonical 子主题"领域内容生成应用"（aigc_domain_application）高度匹配。同时涉及视觉语言模型（VLM）用于病理图像理解与报告生成，因此也匹配 multimodal_understanding_generation 方向。
...
### [212] [Generating Reports or Repeating Templates? Measuring and Mitigating Template Collapse in 3D CT Report Generation](https://arxiv.org/abs/2605.30984)
...
Classification reason: 该论文研究3D CT医学报告生成，属于医疗垂直领域的生成应用，与现有 canonical subtopic "领域内容生成应用"（aigc_domain_application）高度匹配。同时涉及视觉语言模型（VLM）在医学影像中的应用，也匹配 multimodal_understanding_generation 方向。
...
### [213] [DeMaVLA: A Vision-Language-Action Foundation Model for Generalizable Deformable Manipulation](https://arxiv.org/abs/2605.31286)
...
Classification reason: 该论文研究机器人操作领域的视觉-语言-动作基础模型，属于垂直领域（机器人操作）的应用，与现有 subtopic "领域内容生成应用"（aigc_domain_application）匹配。该 subtopic 在 multimodal_understanding_generation 方向下已有记录。
